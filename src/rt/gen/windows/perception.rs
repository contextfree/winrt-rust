...
impl IPerceptionTimestamp {
    #[inline] pub unsafe fn get_target_time(&self) -> Result<foundation::DateTime> {
        let mut out = zeroed();
        let hr = ((*self.lpVtbl).get_TargetTime)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_prediction_amount(&self) -> Result<foundation::TimeSpan> {
        let mut out = zeroed();
...
impl PerceptionTimestampHelper {
    #[inline] pub fn from_historical_target_time(targetTime: foundation::DateTime) -> Result<Option<ComPtr<PerceptionTimestamp>>> { unsafe {
...
impl IPerceptionTimestampHelperStatics {
    #[inline] pub unsafe fn from_historical_target_time(&self, targetTime: foundation::DateTime) -> Result<Option<ComPtr<PerceptionTimestamp>>> {
...
impl ISpatialAnchor {
    ...
    #[inline] pub unsafe fn add_raw_coordinate_system_adjusted(&self, handler: &foundation::TypedEventHandler<SpatialAnchor, SpatialAnchorRawCoordinateSystemAdjustedEventArgs>) -> Result<foundation::EventRegistrationToken> {
        let mut out = zeroed();
        let hr = ((*self.lpVtbl).add_RawCoordinateSystemAdjusted)(self as *const _ as *mut _, handler as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }
    #[inline] pub unsafe fn remove_raw_coordinate_system_adjusted(&self, cookie: foundation::EventRegistrationToken) -> Result<()> {
...
impl SpatialAnchor {
    ...
    #[inline] pub fn try_create_with_position_relative_to(coordinateSystem: &SpatialCoordinateSystem, position: foundation::numerics::Vector3) -> Result<Option<ComPtr<SpatialAnchor>>> { unsafe {
    ...
    #[inline] pub fn try_create_with_position_and_orientation_relative_to(coordinateSystem: &SpatialCoordinateSystem, position: foundation::numerics::Vector3, orientation: foundation::numerics::Quaternion) -> Result<Option<ComPtr<SpatialAnchor>>> { unsafe {
...
impl SpatialAnchorManager {
    #[inline] pub fn request_store_async() -> Result<ComPtr<foundation::IAsyncOperation<SpatialAnchorStore>>> { unsafe {
...
impl ISpatialAnchorManagerStatics {
    #[inline] pub unsafe fn request_store_async(&self) -> Result<ComPtr<foundation::IAsyncOperation<SpatialAnchorStore>>> {
        let mut out = null_mut();
...
impl ISpatialAnchorRawCoordinateSystemAdjustedEventArgs {
    #[inline] pub unsafe fn get_old_raw_coordinate_system_to_new_raw_coordinate_system_transform(&self) -> Result<foundation::numerics::Matrix4x4> {
        let mut out = zeroed();
...
impl ISpatialAnchorStatics {
    ...
    #[inline] pub unsafe fn try_create_with_position_relative_to(&self, coordinateSystem: &SpatialCoordinateSystem, position: foundation::numerics::Vector3) -> Result<Option<ComPtr<SpatialAnchor>>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn try_create_with_position_and_orientation_relative_to(&self, coordinateSystem: &SpatialCoordinateSystem, position: foundation::numerics::Vector3, orientation: foundation::numerics::Quaternion) -> Result<Option<ComPtr<SpatialAnchor>>> {
        let mut out = null_mut();
...
impl ISpatialAnchorStore {
    #[inline] pub unsafe fn get_all_saved_anchors(&self) -> Result<Option<ComPtr<foundation::collections::IMapView<HString, SpatialAnchor>>>> {
        let mut out = null_mut();
...
impl SpatialAnchorTransferManager {
    #[cfg(feature="windows-storage")] #[inline] pub fn try_import_anchors_async(stream: &super::super::storage::streams::IInputStream) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IMapView<HString, SpatialAnchor>>>> { unsafe {
        <Self as RtActivatable<ISpatialAnchorTransferManagerStatics>>::get_activation_factory().try_import_anchors_async(stream)
    }}
    #[cfg(feature="windows-storage")] #[inline] pub fn try_export_anchors_async(anchors: &foundation::collections::IIterable<foundation::collections::IKeyValuePair<HString, SpatialAnchor>>, stream: &super::super::storage::streams::IOutputStream) -> Result<ComPtr<foundation::IAsyncOperation<bool>>> { unsafe {
    ...
    #[inline] pub fn request_access_async() -> Result<ComPtr<foundation::IAsyncOperation<SpatialPerceptionAccessStatus>>> { unsafe {
...
impl ISpatialAnchorTransferManagerStatics {
    #[cfg(feature="windows-storage")] #[inline] pub unsafe fn try_import_anchors_async(&self, stream: &super::super::storage::streams::IInputStream) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IMapView<HString, SpatialAnchor>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).TryImportAnchorsAsync)(self as *const _ as *mut _, stream as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[cfg(feature="windows-storage")] #[inline] pub unsafe fn try_export_anchors_async(&self, anchors: &foundation::collections::IIterable<foundation::collections::IKeyValuePair<HString, SpatialAnchor>>, stream: &super::super::storage::streams::IOutputStream) -> Result<ComPtr<foundation::IAsyncOperation<bool>>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn request_access_async(&self) -> Result<ComPtr<foundation::IAsyncOperation<SpatialPerceptionAccessStatus>>> {
        let mut out = null_mut();
...
impl ISpatialCoordinateSystem {
    #[inline] pub unsafe fn try_get_transform_to(&self, target: &SpatialCoordinateSystem) -> Result<Option<ComPtr<foundation::IReference<foundation::numerics::Matrix4x4>>>> {
        let mut out = null_mut();
...
impl ISpatialEntity {
    ...
    #[inline] pub unsafe fn get_properties(&self) -> Result<Option<ComPtr<foundation::collections::ValueSet>>> {
        let mut out = null_mut();
...
impl SpatialEntity {
    ...
    #[inline] pub fn create_with_spatial_anchor_and_properties(spatialAnchor: &SpatialAnchor, propertySet: &foundation::collections::ValueSet) -> Result<ComPtr<SpatialEntity>> { unsafe {
...
impl ISpatialEntityFactory {
    ...
    #[inline] pub unsafe fn create_with_spatial_anchor_and_properties(&self, spatialAnchor: &SpatialAnchor, propertySet: &foundation::collections::ValueSet) -> Result<ComPtr<SpatialEntity>> {
        let mut out = null_mut();
...
impl ISpatialEntityStore {
    #[inline] pub unsafe fn save_async(&self, entity: &SpatialEntity) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).SaveAsync)(self as *const _ as *mut _, entity as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn remove_async(&self, entity: &SpatialEntity) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
...
impl ISpatialEntityWatcher {
    ...
    #[inline] pub unsafe fn add_added(&self, handler: &foundation::TypedEventHandler<SpatialEntityWatcher, SpatialEntityAddedEventArgs>) -> Result<foundation::EventRegistrationToken> {
        let mut out = zeroed();
    ...
    #[inline] pub unsafe fn add_updated(&self, handler: &foundation::TypedEventHandler<SpatialEntityWatcher, SpatialEntityUpdatedEventArgs>) -> Result<foundation::EventRegistrationToken> {
        let mut out = zeroed();
    ...
    #[inline] pub unsafe fn add_removed(&self, handler: &foundation::TypedEventHandler<SpatialEntityWatcher, SpatialEntityRemovedEventArgs>) -> Result<foundation::EventRegistrationToken> {
        let mut out = zeroed();
    ...
    #[inline] pub unsafe fn add_enumeration_completed(&self, handler: &foundation::TypedEventHandler<SpatialEntityWatcher, IInspectable>) -> Result<foundation::EventRegistrationToken> {
        let mut out = zeroed();
...
impl ISpatialLocation {
    #[inline] pub unsafe fn get_position(&self) -> Result<foundation::numerics::Vector3> {
        let mut out = zeroed();
        let hr = ((*self.lpVtbl).get_Position)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_orientation(&self) -> Result<foundation::numerics::Quaternion> {
        let mut out = zeroed();
        let hr = ((*self.lpVtbl).get_Orientation)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_absolute_linear_velocity(&self) -> Result<foundation::numerics::Vector3> {
        let mut out = zeroed();
        let hr = ((*self.lpVtbl).get_AbsoluteLinearVelocity)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_absolute_linear_acceleration(&self) -> Result<foundation::numerics::Vector3> {
        let mut out = zeroed();
        let hr = ((*self.lpVtbl).get_AbsoluteLinearAcceleration)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_absolute_angular_velocity(&self) -> Result<foundation::numerics::Quaternion> {
        let mut out = zeroed();
        let hr = ((*self.lpVtbl).get_AbsoluteAngularVelocity)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_absolute_angular_acceleration(&self) -> Result<foundation::numerics::Quaternion> {
        let mut out = zeroed();
...
impl ISpatialLocator {
    ...
    #[inline] pub unsafe fn add_locatability_changed(&self, handler: &foundation::TypedEventHandler<SpatialLocator, IInspectable>) -> Result<foundation::EventRegistrationToken> {
        let mut out = zeroed();
        let hr = ((*self.lpVtbl).add_LocatabilityChanged)(self as *const _ as *mut _, handler as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }
    #[inline] pub unsafe fn remove_locatability_changed(&self, cookie: foundation::EventRegistrationToken) -> Result<()> {
        let hr = ((*self.lpVtbl).remove_LocatabilityChanged)(self as *const _ as *mut _, cookie);
        if hr == S_OK { Ok(()) } else { err(hr) }
    }
    #[inline] pub unsafe fn add_positional_tracking_deactivating(&self, handler: &foundation::TypedEventHandler<SpatialLocator, SpatialLocatorPositionalTrackingDeactivatingEventArgs>) -> Result<foundation::EventRegistrationToken> {
        let mut out = zeroed();
        let hr = ((*self.lpVtbl).add_PositionalTrackingDeactivating)(self as *const _ as *mut _, handler as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }
    #[inline] pub unsafe fn remove_positional_tracking_deactivating(&self, cookie: foundation::EventRegistrationToken) -> Result<()> {
    ...
    #[inline] pub unsafe fn create_attached_frame_of_reference_at_current_heading_with_position(&self, relativePosition: foundation::numerics::Vector3) -> Result<Option<ComPtr<SpatialLocatorAttachedFrameOfReference>>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn create_attached_frame_of_reference_at_current_heading_with_position_and_orientation(&self, relativePosition: foundation::numerics::Vector3, relativeOrientation: foundation::numerics::Quaternion) -> Result<Option<ComPtr<SpatialLocatorAttachedFrameOfReference>>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn create_stationary_frame_of_reference_at_current_location_with_position(&self, relativePosition: foundation::numerics::Vector3) -> Result<Option<ComPtr<SpatialStationaryFrameOfReference>>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn create_stationary_frame_of_reference_at_current_location_with_position_and_orientation(&self, relativePosition: foundation::numerics::Vector3, relativeOrientation: foundation::numerics::Quaternion) -> Result<Option<ComPtr<SpatialStationaryFrameOfReference>>> {
        let mut out = null_mut();
...
impl ISpatialLocatorAttachedFrameOfReference {
    #[inline] pub unsafe fn get_relative_position(&self) -> Result<foundation::numerics::Vector3> {
        let mut out = zeroed();
        let hr = ((*self.lpVtbl).get_RelativePosition)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }
    #[inline] pub unsafe fn set_relative_position(&self, value: foundation::numerics::Vector3) -> Result<()> {
        let hr = ((*self.lpVtbl).put_RelativePosition)(self as *const _ as *mut _, value);
        if hr == S_OK { Ok(()) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_relative_orientation(&self) -> Result<foundation::numerics::Quaternion> {
        let mut out = zeroed();
        let hr = ((*self.lpVtbl).get_RelativeOrientation)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }
    #[inline] pub unsafe fn set_relative_orientation(&self, value: foundation::numerics::Quaternion) -> Result<()> {
    ...
    #[inline] pub unsafe fn try_get_relative_heading_at_timestamp(&self, timestamp: &super::PerceptionTimestamp) -> Result<Option<ComPtr<foundation::IReference<f64>>>> {
        let mut out = null_mut();
...
impl ISpatialStageFrameOfReference {
    ...
    #[inline] pub unsafe fn try_get_movement_bounds(&self, coordinateSystem: &SpatialCoordinateSystem) -> Result<ComArray<foundation::numerics::Vector3>> {
...
impl SpatialStageFrameOfReference {
    ...
    #[inline] pub fn add_current_changed(handler: &foundation::EventHandler<IInspectable>) -> Result<foundation::EventRegistrationToken> { unsafe {
        <Self as RtActivatable<ISpatialStageFrameOfReferenceStatics>>::get_activation_factory().add_current_changed(handler)
    }}
    #[inline] pub fn remove_current_changed(cookie: foundation::EventRegistrationToken) -> Result<()> { unsafe {
        <Self as RtActivatable<ISpatialStageFrameOfReferenceStatics>>::get_activation_factory().remove_current_changed(cookie)
    }}
    #[inline] pub fn request_new_stage_async() -> Result<ComPtr<foundation::IAsyncOperation<SpatialStageFrameOfReference>>> { unsafe {
...
impl ISpatialStageFrameOfReferenceStatics {
    ...
    #[inline] pub unsafe fn add_current_changed(&self, handler: &foundation::EventHandler<IInspectable>) -> Result<foundation::EventRegistrationToken> {
        let mut out = zeroed();
        let hr = ((*self.lpVtbl).add_CurrentChanged)(self as *const _ as *mut _, handler as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }
    #[inline] pub unsafe fn remove_current_changed(&self, cookie: foundation::EventRegistrationToken) -> Result<()> {
        let hr = ((*self.lpVtbl).remove_CurrentChanged)(self as *const _ as *mut _, cookie);
        if hr == S_OK { Ok(()) } else { err(hr) }
    }
    #[inline] pub unsafe fn request_new_stage_async(&self) -> Result<ComPtr<foundation::IAsyncOperation<SpatialStageFrameOfReference>>> {
        let mut out = null_mut();
...
impl ISpatialSurfaceInfo {
    ...
    #[inline] pub unsafe fn get_update_time(&self) -> Result<foundation::DateTime> {
        let mut out = zeroed();
        let hr = ((*self.lpVtbl).get_UpdateTime)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }
    #[inline] pub unsafe fn try_get_bounds(&self, coordinateSystem: &super::SpatialCoordinateSystem) -> Result<Option<ComPtr<foundation::IReference<super::SpatialBoundingOrientedBox>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).TryGetBounds)(self as *const _ as *mut _, coordinateSystem as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap_optional(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn try_compute_latest_mesh_async(&self, maxTrianglesPerCubicMeter: f64) -> Result<ComPtr<foundation::IAsyncOperation<SpatialSurfaceMesh>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).TryComputeLatestMeshAsync)(self as *const _ as *mut _, maxTrianglesPerCubicMeter, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn try_compute_latest_mesh_with_options_async(&self, maxTrianglesPerCubicMeter: f64, options: &SpatialSurfaceMeshOptions) -> Result<ComPtr<foundation::IAsyncOperation<SpatialSurfaceMesh>>> {
        let mut out = null_mut();
...
impl ISpatialSurfaceMesh {
    ...
    #[inline] pub unsafe fn get_vertex_position_scale(&self) -> Result<foundation::numerics::Vector3> {
        let mut out = zeroed();
...
impl SpatialSurfaceMeshOptions {
    #[cfg(feature="windows-graphics")] #[inline] pub fn get_supported_vertex_position_formats() -> Result<Option<ComPtr<foundation::collections::IVectorView<::rt::gen::windows::graphics::directx::DirectXPixelFormat>>>> { unsafe {
        <Self as RtActivatable<ISpatialSurfaceMeshOptionsStatics>>::get_activation_factory().get_supported_vertex_position_formats()
    }}
    #[cfg(feature="windows-graphics")] #[inline] pub fn get_supported_triangle_index_formats() -> Result<Option<ComPtr<foundation::collections::IVectorView<::rt::gen::windows::graphics::directx::DirectXPixelFormat>>>> { unsafe {
        <Self as RtActivatable<ISpatialSurfaceMeshOptionsStatics>>::get_activation_factory().get_supported_triangle_index_formats()
    }}
    #[cfg(feature="windows-graphics")] #[inline] pub fn get_supported_vertex_normal_formats() -> Result<Option<ComPtr<foundation::collections::IVectorView<::rt::gen::windows::graphics::directx::DirectXPixelFormat>>>> { unsafe {
...
impl ISpatialSurfaceMeshOptionsStatics {
    #[cfg(feature="windows-graphics")] #[inline] pub unsafe fn get_supported_vertex_position_formats(&self) -> Result<Option<ComPtr<foundation::collections::IVectorView<::rt::gen::windows::graphics::directx::DirectXPixelFormat>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).get_SupportedVertexPositionFormats)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap_optional(out)) } else { err(hr) }
    }
    #[cfg(feature="windows-graphics")] #[inline] pub unsafe fn get_supported_triangle_index_formats(&self) -> Result<Option<ComPtr<foundation::collections::IVectorView<::rt::gen::windows::graphics::directx::DirectXPixelFormat>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).get_SupportedTriangleIndexFormats)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap_optional(out)) } else { err(hr) }
    }
    #[cfg(feature="windows-graphics")] #[inline] pub unsafe fn get_supported_vertex_normal_formats(&self) -> Result<Option<ComPtr<foundation::collections::IVectorView<::rt::gen::windows::graphics::directx::DirectXPixelFormat>>>> {
        let mut out = null_mut();
...
impl ISpatialSurfaceObserver {
    #[inline] pub unsafe fn get_observed_surfaces(&self) -> Result<Option<ComPtr<foundation::collections::IMapView<Guid, SpatialSurfaceInfo>>>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn set_bounding_volumes(&self, bounds: &foundation::collections::IIterable<super::SpatialBoundingVolume>) -> Result<()> {
        let hr = ((*self.lpVtbl).SetBoundingVolumes)(self as *const _ as *mut _, bounds as *const _ as *mut _);
        if hr == S_OK { Ok(()) } else { err(hr) }
    }
    #[inline] pub unsafe fn add_observed_surfaces_changed(&self, handler: &foundation::TypedEventHandler<SpatialSurfaceObserver, IInspectable>) -> Result<foundation::EventRegistrationToken> {
        let mut out = zeroed();
        let hr = ((*self.lpVtbl).add_ObservedSurfacesChanged)(self as *const _ as *mut _, handler as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }
    #[inline] pub unsafe fn remove_observed_surfaces_changed(&self, token: foundation::EventRegistrationToken) -> Result<()> {
...
impl SpatialSurfaceObserver {
    #[inline] pub fn request_access_async() -> Result<ComPtr<foundation::IAsyncOperation<super::SpatialPerceptionAccessStatus>>> { unsafe {
...
impl ISpatialSurfaceObserverStatics {
    #[inline] pub unsafe fn request_access_async(&self) -> Result<ComPtr<foundation::IAsyncOperation<super::SpatialPerceptionAccessStatus>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).RequestAccessAsync)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
...
impl IHeadPose {
    ...
    #[inline] pub unsafe fn get_forward_direction(&self) -> Result<foundation::numerics::Vector3> {
        let mut out = zeroed();
        let hr = ((*self.lpVtbl).get_ForwardDirection)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_up_direction(&self) -> Result<foundation::numerics::Vector3> {
        let mut out = zeroed();
...
impl CorePerceptionAutomation {
    #[inline] pub fn set_activation_factory_provider(provider: &foundation::IGetActivationFactory) -> Result<()> { unsafe {
...
impl ICorePerceptionAutomationStatics {
    #[inline] pub unsafe fn set_activation_factory_provider(&self, provider: &foundation::IGetActivationFactory) -> Result<()> {
