...
RT_INTERFACE!{interface ISpatialAnchorExporter(ISpatialAnchorExporterVtbl): IInspectable(IInspectableVtbl) [IID_ISpatialAnchorExporter] {
    fn GetAnchorExportSufficiencyAsync(&self, anchor: <SpatialAnchor as RtType>::Abi, purpose: SpatialAnchorExportPurpose, out: *mut *mut foundation::IAsyncOperation<SpatialAnchorExportSufficiency>) -> HRESULT,
    #[cfg(feature="windows-storage")] fn TryExportAnchorAsync(&self, anchor: <SpatialAnchor as RtType>::Abi, purpose: SpatialAnchorExportPurpose, stream: *mut super::super::storage::streams::IOutputStream, out: *mut *mut foundation::IAsyncOperation<bool>) -> HRESULT
}}
impl ComPtr<ISpatialAnchorExporter> {
    ...
    #[cfg(feature="windows-storage")] #[inline] pub fn try_export_anchor_async(&self, anchor: &SpatialAnchor, purpose: SpatialAnchorExportPurpose, stream: &ComPtr<super::super::storage::streams::IOutputStream>) -> Result<ComPtr<foundation::IAsyncOperation<bool>>> { unsafe { 
        let mut out = null_mut();
...
RT_INTERFACE!{interface ISpatialCoordinateSystem(ISpatialCoordinateSystemVtbl): IInspectable(IInspectableVtbl) [IID_ISpatialCoordinateSystem] {
    fn TryGetTransformTo(&self, target: <SpatialCoordinateSystem as RtType>::Abi, out: *mut *mut foundation::IReference<foundation::numerics::Matrix4x4>) -> HRESULT
}}
...
RT_INTERFACE!{interface ISpatialEntityStore(ISpatialEntityStoreVtbl): IInspectable(IInspectableVtbl) [IID_ISpatialEntityStore] {
    fn SaveAsync(&self, entity: <SpatialEntity as RtType>::Abi, out: *mut *mut foundation::IAsyncAction) -> HRESULT,
    fn RemoveAsync(&self, entity: <SpatialEntity as RtType>::Abi, out: *mut *mut foundation::IAsyncAction) -> HRESULT,
...
RT_INTERFACE!{interface ISpatialLocatorAttachedFrameOfReference(ISpatialLocatorAttachedFrameOfReferenceVtbl): IInspectable(IInspectableVtbl) [IID_ISpatialLocatorAttachedFrameOfReference] {
    ...
    fn TryGetRelativeHeadingAtTimestamp(&self, timestamp: <super::PerceptionTimestamp as RtType>::Abi, out: *mut *mut foundation::IReference<f64>) -> HRESULT
}}
...
RT_INTERFACE!{interface ISpatialSurfaceInfo(ISpatialSurfaceInfoVtbl): IInspectable(IInspectableVtbl) [IID_ISpatialSurfaceInfo] {
    ...
    fn TryGetBounds(&self, coordinateSystem: <super::SpatialCoordinateSystem as RtType>::Abi, out: *mut *mut foundation::IReference<super::SpatialBoundingOrientedBox>) -> HRESULT,
    ...
    fn TryComputeLatestMeshWithOptionsAsync(&self, maxTrianglesPerCubicMeter: f64, options: <SpatialSurfaceMeshOptions as RtType>::Abi, out: *mut *mut foundation::IAsyncOperation<SpatialSurfaceMesh>) -> HRESULT
}}
