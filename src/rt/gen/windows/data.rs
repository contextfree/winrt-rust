...
impl IHtmlUtilities {
    #[inline] pub fn convert_to_text(&self, html: &HStringArg) -> Result<HString> { unsafe { 
        ...
        let hr = (self.get_vtbl().ConvertToText)(self.get_abi() as *const _ as *mut _, html.get(), &mut out);
...
impl IJsonArray {
    #[inline] pub fn get_object_at(&self, index: u32) -> Result<Option<JsonObject>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().GetObjectAt)(self.get_abi() as *const _ as *mut _, index, &mut out);
        if hr == S_OK { Ok(JsonObject::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_array_at(&self, index: u32) -> Result<Option<JsonArray>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().GetArrayAt)(self.get_abi() as *const _ as *mut _, index, &mut out);
        if hr == S_OK { Ok(JsonArray::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_string_at(&self, index: u32) -> Result<HString> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().GetStringAt)(self.get_abi() as *const _ as *mut _, index, &mut out);
        if hr == S_OK { Ok(HString::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_number_at(&self, index: u32) -> Result<f64> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().GetNumberAt)(self.get_abi() as *const _ as *mut _, index, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn get_boolean_at(&self, index: u32) -> Result<bool> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().GetBooleanAt)(self.get_abi() as *const _ as *mut _, index, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
}
...
impl IJsonArrayStatics {
    ...
    #[inline] pub fn try_parse(&self, input: &HStringArg) -> Result<(Option<JsonArray>, bool)> { unsafe { 
        ...
        let hr = (self.get_vtbl().TryParse)(self.get_abi() as *const _ as *mut _, input.get(), &mut result, &mut out);
...
impl IJsonErrorStatics2 {
    #[inline] pub fn get_json_status(&self, hresult: i32) -> Result<JsonErrorStatus> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().GetJsonStatus)(self.get_abi() as *const _ as *mut _, hresult, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
}
...
impl IJsonObject {
    #[inline] pub fn get_named_value(&self, name: &HStringArg) -> Result<Option<JsonValue>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().GetNamedValue)(self.get_abi() as *const _ as *mut _, name.get(), &mut out);
    ...
    #[inline] pub fn set_named_value(&self, name: &HStringArg, value: &IJsonValue) -> Result<()> { unsafe { 
        let hr = (self.get_vtbl().SetNamedValue)(self.get_abi() as *const _ as *mut _, name.get(), value.get_abi() as *const _ as *mut _);
        if hr == S_OK { Ok(()) } else { err(hr) }
    }}
    #[inline] pub fn get_named_object(&self, name: &HStringArg) -> Result<Option<JsonObject>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().GetNamedObject)(self.get_abi() as *const _ as *mut _, name.get(), &mut out);
        if hr == S_OK { Ok(JsonObject::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_named_array(&self, name: &HStringArg) -> Result<Option<JsonArray>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().GetNamedArray)(self.get_abi() as *const _ as *mut _, name.get(), &mut out);
        if hr == S_OK { Ok(JsonArray::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_named_string(&self, name: &HStringArg) -> Result<HString> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().GetNamedString)(self.get_abi() as *const _ as *mut _, name.get(), &mut out);
        if hr == S_OK { Ok(HString::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_named_number(&self, name: &HStringArg) -> Result<f64> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().GetNamedNumber)(self.get_abi() as *const _ as *mut _, name.get(), &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn get_named_boolean(&self, name: &HStringArg) -> Result<bool> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().GetNamedBoolean)(self.get_abi() as *const _ as *mut _, name.get(), &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
}
...
impl IJsonObjectWithDefaultValues {
    #[inline] pub fn get_named_value_or_default(&self, name: &HStringArg, defaultValue: &JsonValue) -> Result<Option<JsonValue>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().GetNamedValueOrDefault)(self.get_abi() as *const _ as *mut _, name.get(), defaultValue.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(JsonValue::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_named_object_or_default(&self, name: &HStringArg, defaultValue: &JsonObject) -> Result<Option<JsonObject>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().GetNamedObjectOrDefault)(self.get_abi() as *const _ as *mut _, name.get(), defaultValue.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(JsonObject::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_named_string_or_default(&self, name: &HStringArg, defaultValue: &HStringArg) -> Result<HString> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().GetNamedStringOrDefault)(self.get_abi() as *const _ as *mut _, name.get(), defaultValue.get(), &mut out);
        if hr == S_OK { Ok(HString::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_named_array_or_default(&self, name: &HStringArg, defaultValue: &JsonArray) -> Result<Option<JsonArray>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().GetNamedArrayOrDefault)(self.get_abi() as *const _ as *mut _, name.get(), defaultValue.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(JsonArray::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_named_number_or_default(&self, name: &HStringArg, defaultValue: f64) -> Result<f64> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().GetNamedNumberOrDefault)(self.get_abi() as *const _ as *mut _, name.get(), defaultValue, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn get_named_boolean_or_default(&self, name: &HStringArg, defaultValue: bool) -> Result<bool> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().GetNamedBooleanOrDefault)(self.get_abi() as *const _ as *mut _, name.get(), defaultValue, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
}
...
impl IJsonValue {
    #[inline] pub fn get_value_type(&self) -> Result<JsonValueType> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().get_ValueType)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn stringify(&self) -> Result<HString> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().Stringify)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(HString::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_string(&self) -> Result<HString> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().GetString)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(HString::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_number(&self) -> Result<f64> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().GetNumber)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn get_boolean(&self) -> Result<bool> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().GetBoolean)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn get_array(&self) -> Result<Option<JsonArray>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().GetArray)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(JsonArray::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_object(&self) -> Result<Option<JsonObject>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().GetObject)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(JsonObject::wrap(out)) } else { err(hr) }
    }}
}
...
impl IJsonValueStatics {
    ...
    #[inline] pub fn create_boolean_value(&self, input: bool) -> Result<Option<JsonValue>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().CreateBooleanValue)(self.get_abi() as *const _ as *mut _, input, &mut out);
        if hr == S_OK { Ok(JsonValue::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn create_number_value(&self, input: f64) -> Result<Option<JsonValue>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().CreateNumberValue)(self.get_abi() as *const _ as *mut _, input, &mut out);
        if hr == S_OK { Ok(JsonValue::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn create_string_value(&self, input: &HStringArg) -> Result<Option<JsonValue>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().CreateStringValue)(self.get_abi() as *const _ as *mut _, input.get(), &mut out);
        if hr == S_OK { Ok(JsonValue::wrap(out)) } else { err(hr) }
    }}
}
...
impl IJsonValueStatics2 {
    #[inline] pub fn create_null_value(&self) -> Result<Option<JsonValue>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().CreateNullValue)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(JsonValue::wrap(out)) } else { err(hr) }
    }}
}
...
impl IPdfDocument {
    #[inline] pub fn get_page(&self, pageIndex: u32) -> Result<Option<PdfPage>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().GetPage)(self.get_abi() as *const _ as *mut _, pageIndex, &mut out);
        if hr == S_OK { Ok(PdfPage::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_page_count(&self) -> Result<u32> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().get_PageCount)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn get_is_password_protected(&self) -> Result<bool> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().get_IsPasswordProtected)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
}
...
impl IPdfDocumentStatics {
    #[cfg(feature="windows-storage")] #[inline] pub fn load_from_file_async(&self, file: &super::super::storage::IStorageFile) -> Result<foundation::IAsyncOperation<PdfDocument>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().LoadFromFileAsync)(self.get_abi() as *const _ as *mut _, file.get_abi() as *const _ as *mut _, &mut out);
    ...
    #[cfg(feature="windows-storage")] #[inline] pub fn load_from_file_with_password_async(&self, file: &super::super::storage::IStorageFile, password: &HStringArg) -> Result<foundation::IAsyncOperation<PdfDocument>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().LoadFromFileWithPasswordAsync)(self.get_abi() as *const _ as *mut _, file.get_abi() as *const _ as *mut _, password.get(), &mut out);
        if hr == S_OK { Ok(foundation::IAsyncOperation::wrap_nonnull(out)) } else { err(hr) }
    }}
    #[cfg(feature="windows-storage")] #[inline] pub fn load_from_stream_async(&self, inputStream: &super::super::storage::streams::IRandomAccessStream) -> Result<foundation::IAsyncOperation<PdfDocument>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().LoadFromStreamAsync)(self.get_abi() as *const _ as *mut _, inputStream.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(foundation::IAsyncOperation::wrap_nonnull(out)) } else { err(hr) }
    }}
    #[cfg(feature="windows-storage")] #[inline] pub fn load_from_stream_with_password_async(&self, inputStream: &super::super::storage::streams::IRandomAccessStream, password: &HStringArg) -> Result<foundation::IAsyncOperation<PdfDocument>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().LoadFromStreamWithPasswordAsync)(self.get_abi() as *const _ as *mut _, inputStream.get_abi() as *const _ as *mut _, password.get(), &mut out);
        if hr == S_OK { Ok(foundation::IAsyncOperation::wrap_nonnull(out)) } else { err(hr) }
    }}
}
...
impl IPdfPage {
    #[cfg(feature="windows-storage")] #[inline] pub fn render_to_stream_async(&self, outputStream: &super::super::storage::streams::IRandomAccessStream) -> Result<foundation::IAsyncAction> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().RenderToStreamAsync)(self.get_abi() as *const _ as *mut _, outputStream.get_abi() as *const _ as *mut _, &mut out);
    ...
    #[cfg(feature="windows-storage")] #[inline] pub fn render_with_options_to_stream_async(&self, outputStream: &super::super::storage::streams::IRandomAccessStream, options: &PdfPageRenderOptions) -> Result<foundation::IAsyncAction> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().RenderWithOptionsToStreamAsync)(self.get_abi() as *const _ as *mut _, outputStream.get_abi() as *const _ as *mut _, options.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(foundation::IAsyncAction::wrap_nonnull(out)) } else { err(hr) }
    }}
    #[inline] pub fn prepare_page_async(&self) -> Result<foundation::IAsyncAction> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().PreparePageAsync)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(foundation::IAsyncAction::wrap_nonnull(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_index(&self) -> Result<u32> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().get_Index)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    ...
    #[inline] pub fn get_dimensions(&self) -> Result<Option<PdfPageDimensions>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().get_Dimensions)(self.get_abi() as *const _ as *mut _, &mut out);
    ...
    #[inline] pub fn get_preferred_zoom(&self) -> Result<f32> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().get_PreferredZoom)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
}
...
impl IPdfPageDimensions {
    #[inline] pub fn get_media_box(&self) -> Result<foundation::Rect> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().get_MediaBox)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn get_crop_box(&self) -> Result<foundation::Rect> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().get_CropBox)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn get_bleed_box(&self) -> Result<foundation::Rect> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().get_BleedBox)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn get_trim_box(&self) -> Result<foundation::Rect> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().get_TrimBox)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn get_art_box(&self) -> Result<foundation::Rect> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().get_ArtBox)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
}
...
impl IPdfPageRenderOptions {
    #[inline] pub fn get_source_rect(&self) -> Result<foundation::Rect> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().get_SourceRect)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn set_source_rect(&self, value: foundation::Rect) -> Result<()> { unsafe { 
        let hr = (self.get_vtbl().put_SourceRect)(self.get_abi() as *const _ as *mut _, value);
        if hr == S_OK { Ok(()) } else { err(hr) }
    }}
    #[inline] pub fn get_destination_width(&self) -> Result<u32> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().get_DestinationWidth)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn set_destination_width(&self, value: u32) -> Result<()> { unsafe { 
        let hr = (self.get_vtbl().put_DestinationWidth)(self.get_abi() as *const _ as *mut _, value);
        if hr == S_OK { Ok(()) } else { err(hr) }
    }}
    #[inline] pub fn get_destination_height(&self) -> Result<u32> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().get_DestinationHeight)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn set_destination_height(&self, value: u32) -> Result<()> { unsafe { 
        let hr = (self.get_vtbl().put_DestinationHeight)(self.get_abi() as *const _ as *mut _, value);
        if hr == S_OK { Ok(()) } else { err(hr) }
    }}
    ...
    #[inline] pub fn get_is_ignoring_high_contrast(&self) -> Result<bool> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().get_IsIgnoringHighContrast)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn set_is_ignoring_high_contrast(&self, value: bool) -> Result<()> { unsafe { 
        let hr = (self.get_vtbl().put_IsIgnoringHighContrast)(self.get_abi() as *const _ as *mut _, value);
        if hr == S_OK { Ok(()) } else { err(hr) }
    }}
    #[inline] pub fn get_bitmap_encoder_id(&self) -> Result<Guid> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().get_BitmapEncoderId)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn set_bitmap_encoder_id(&self, value: Guid) -> Result<()> { unsafe { 
        let hr = (self.get_vtbl().put_BitmapEncoderId)(self.get_abi() as *const _ as *mut _, value);
        if hr == S_OK { Ok(()) } else { err(hr) }
    }}
}
...
impl IAlternateWordForm {
    #[inline] pub fn get_source_text_segment(&self) -> Result<TextSegment> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().get_SourceTextSegment)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    ...
    #[inline] pub fn get_normalization_format(&self) -> Result<AlternateNormalizationFormat> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().get_NormalizationFormat)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
}
...
impl SelectableWordSegmentsTokenizingHandler {
    #[inline] pub fn invoke(&self, precedingWords: &foundation::collections::IIterable<SelectableWordSegment>, words: &foundation::collections::IIterable<SelectableWordSegment>) -> Result<()> { unsafe { 
        let hr = (self.get_vtbl().Invoke)(self.get_abi() as *const _ as *mut _, precedingWords.get_abi() as *const _ as *mut _, words.get_abi() as *const _ as *mut _);
        if hr == S_OK { Ok(()) } else { err(hr) }
    }}
}
...
impl ISelectableWordsSegmenter {
    ...
    #[inline] pub fn get_token_at(&self, text: &HStringArg, startIndex: u32) -> Result<Option<SelectableWordSegment>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().GetTokenAt)(self.get_abi() as *const _ as *mut _, text.get(), startIndex, &mut out);
    ...
    #[inline] pub fn get_tokens(&self, text: &HStringArg) -> Result<Option<foundation::collections::IVectorView<SelectableWordSegment>>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().GetTokens)(self.get_abi() as *const _ as *mut _, text.get(), &mut out);
    ...
    #[inline] pub fn tokenize(&self, text: &HStringArg, startIndex: u32, handler: &SelectableWordSegmentsTokenizingHandler) -> Result<()> { unsafe { 
        let hr = (self.get_vtbl().Tokenize)(self.get_abi() as *const _ as *mut _, text.get(), startIndex, handler.get_abi() as *const _ as *mut _);
        if hr == S_OK { Ok(()) } else { err(hr) }
    }}
}
...
impl ISelectableWordsSegmenterFactory {
    #[inline] pub fn create_with_language(&self, language: &HStringArg) -> Result<SelectableWordsSegmenter> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().CreateWithLanguage)(self.get_abi() as *const _ as *mut _, language.get(), &mut out);
...
impl ISemanticTextQuery {
    #[inline] pub fn find(&self, content: &HStringArg) -> Result<Option<foundation::collections::IVectorView<TextSegment>>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().Find)(self.get_abi() as *const _ as *mut _, content.get(), &mut out);
        if hr == S_OK { Ok(foundation::collections::IVectorView::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn find_in_property(&self, propertyContent: &HStringArg, propertyName: &HStringArg) -> Result<Option<foundation::collections::IVectorView<TextSegment>>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().FindInProperty)(self.get_abi() as *const _ as *mut _, propertyContent.get(), propertyName.get(), &mut out);
        if hr == S_OK { Ok(foundation::collections::IVectorView::wrap(out)) } else { err(hr) }
    }}
}
...
impl ISemanticTextQueryFactory {
    #[inline] pub fn create(&self, aqsFilter: &HStringArg) -> Result<SemanticTextQuery> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().Create)(self.get_abi() as *const _ as *mut _, aqsFilter.get(), &mut out);
    ...
    #[inline] pub fn create_with_language(&self, aqsFilter: &HStringArg, filterLanguage: &HStringArg) -> Result<SemanticTextQuery> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().CreateWithLanguage)(self.get_abi() as *const _ as *mut _, aqsFilter.get(), filterLanguage.get(), &mut out);
        if hr == S_OK { Ok(SemanticTextQuery::wrap_nonnull(out)) } else { err(hr) }
    }}
}
...
impl ITextConversionGenerator {
    ...
    #[inline] pub fn get_language_available_but_not_installed(&self) -> Result<bool> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().get_LanguageAvailableButNotInstalled)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn get_candidates_async(&self, input: &HStringArg) -> Result<foundation::IAsyncOperation<foundation::collections::IVectorView<HString>>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().GetCandidatesAsync)(self.get_abi() as *const _ as *mut _, input.get(), &mut out);
        if hr == S_OK { Ok(foundation::IAsyncOperation::wrap_nonnull(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_candidates_with_max_count_async(&self, input: &HStringArg, maxCandidates: u32) -> Result<foundation::IAsyncOperation<foundation::collections::IVectorView<HString>>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().GetCandidatesWithMaxCountAsync)(self.get_abi() as *const _ as *mut _, input.get(), maxCandidates, &mut out);
        if hr == S_OK { Ok(foundation::IAsyncOperation::wrap_nonnull(out)) } else { err(hr) }
    }}
}
...
impl ITextConversionGeneratorFactory {
    #[inline] pub fn create(&self, languageTag: &HStringArg) -> Result<TextConversionGenerator> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().Create)(self.get_abi() as *const _ as *mut _, languageTag.get(), &mut out);
...
impl ITextPhoneme {
    ...
    #[inline] pub fn get_reading_text(&self) -> Result<HString> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().get_ReadingText)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(HString::wrap(out)) } else { err(hr) }
    }}
}
...
impl ITextPredictionGenerator2 {
    #[inline] pub fn get_candidates_with_parameters_async(&self, input: &HStringArg, maxCandidates: u32, predictionOptions: TextPredictionOptions, previousStrings: &foundation::collections::IIterable<HString>) -> Result<foundation::IAsyncOperation<foundation::collections::IVectorView<HString>>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().GetCandidatesWithParametersAsync)(self.get_abi() as *const _ as *mut _, input.get(), maxCandidates, predictionOptions, previousStrings.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(foundation::IAsyncOperation::wrap_nonnull(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_next_word_candidates_async(&self, maxCandidates: u32, previousStrings: &foundation::collections::IIterable<HString>) -> Result<foundation::IAsyncOperation<foundation::collections::IVectorView<HString>>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().GetNextWordCandidatesAsync)(self.get_abi() as *const _ as *mut _, maxCandidates, previousStrings.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(foundation::IAsyncOperation::wrap_nonnull(out)) } else { err(hr) }
    }}
    #[cfg(feature="windows-ui")] #[inline] pub fn get_input_scope(&self) -> Result<super::super::ui::text::core::CoreTextInputScope> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().get_InputScope)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[cfg(feature="windows-ui")] #[inline] pub fn set_input_scope(&self, value: super::super::ui::text::core::CoreTextInputScope) -> Result<()> { unsafe { 
        let hr = (self.get_vtbl().put_InputScope)(self.get_abi() as *const _ as *mut _, value);
        if hr == S_OK { Ok(()) } else { err(hr) }
    }}
}
...
impl ITextReverseConversionGenerator {
    ...
    #[inline] pub fn convert_back_async(&self, input: &HStringArg) -> Result<foundation::IAsyncOperation<HString>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().ConvertBackAsync)(self.get_abi() as *const _ as *mut _, input.get(), &mut out);
        if hr == S_OK { Ok(foundation::IAsyncOperation::wrap_nonnull(out)) } else { err(hr) }
    }}
}
...
impl ITextReverseConversionGenerator2 {
    #[inline] pub fn get_phonemes_async(&self, input: &HStringArg) -> Result<foundation::IAsyncOperation<foundation::collections::IVectorView<TextPhoneme>>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().GetPhonemesAsync)(self.get_abi() as *const _ as *mut _, input.get(), &mut out);
        if hr == S_OK { Ok(foundation::IAsyncOperation::wrap_nonnull(out)) } else { err(hr) }
    }}
}
...
impl IUnicodeCharactersStatics {
    #[inline] pub fn get_codepoint_from_surrogate_pair(&self, highSurrogate: u32, lowSurrogate: u32) -> Result<u32> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().GetCodepointFromSurrogatePair)(self.get_abi() as *const _ as *mut _, highSurrogate, lowSurrogate, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn get_surrogate_pair_from_codepoint(&self, codepoint: u32) -> Result<(Char, Char)> { unsafe { 
        ...
        let hr = (self.get_vtbl().GetSurrogatePairFromCodepoint)(self.get_abi() as *const _ as *mut _, codepoint, &mut highSurrogate, &mut lowSurrogate);
    ...
    #[inline] pub fn is_high_surrogate(&self, codepoint: u32) -> Result<bool> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().IsHighSurrogate)(self.get_abi() as *const _ as *mut _, codepoint, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn is_low_surrogate(&self, codepoint: u32) -> Result<bool> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().IsLowSurrogate)(self.get_abi() as *const _ as *mut _, codepoint, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn is_supplementary(&self, codepoint: u32) -> Result<bool> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().IsSupplementary)(self.get_abi() as *const _ as *mut _, codepoint, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn is_noncharacter(&self, codepoint: u32) -> Result<bool> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().IsNoncharacter)(self.get_abi() as *const _ as *mut _, codepoint, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn is_whitespace(&self, codepoint: u32) -> Result<bool> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().IsWhitespace)(self.get_abi() as *const _ as *mut _, codepoint, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn is_alphabetic(&self, codepoint: u32) -> Result<bool> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().IsAlphabetic)(self.get_abi() as *const _ as *mut _, codepoint, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn is_cased(&self, codepoint: u32) -> Result<bool> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().IsCased)(self.get_abi() as *const _ as *mut _, codepoint, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn is_uppercase(&self, codepoint: u32) -> Result<bool> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().IsUppercase)(self.get_abi() as *const _ as *mut _, codepoint, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn is_lowercase(&self, codepoint: u32) -> Result<bool> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().IsLowercase)(self.get_abi() as *const _ as *mut _, codepoint, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn is_id_start(&self, codepoint: u32) -> Result<bool> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().IsIdStart)(self.get_abi() as *const _ as *mut _, codepoint, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn is_id_continue(&self, codepoint: u32) -> Result<bool> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().IsIdContinue)(self.get_abi() as *const _ as *mut _, codepoint, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn is_grapheme_base(&self, codepoint: u32) -> Result<bool> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().IsGraphemeBase)(self.get_abi() as *const _ as *mut _, codepoint, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn is_grapheme_extend(&self, codepoint: u32) -> Result<bool> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().IsGraphemeExtend)(self.get_abi() as *const _ as *mut _, codepoint, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn get_numeric_type(&self, codepoint: u32) -> Result<UnicodeNumericType> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().GetNumericType)(self.get_abi() as *const _ as *mut _, codepoint, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn get_general_category(&self, codepoint: u32) -> Result<UnicodeGeneralCategory> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().GetGeneralCategory)(self.get_abi() as *const _ as *mut _, codepoint, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
}
...
impl IWordSegment {
    ...
    #[inline] pub fn get_alternate_forms(&self) -> Result<Option<foundation::collections::IVectorView<AlternateWordForm>>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().get_AlternateForms)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(foundation::collections::IVectorView::wrap(out)) } else { err(hr) }
    }}
}
...
impl IDtdEntity {
    #[inline] pub fn get_public_id(&self) -> Result<Option<IInspectable>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().get_PublicId)(self.get_abi() as *const _ as *mut _, &mut out);
    ...
    #[inline] pub fn get_notation_name(&self) -> Result<Option<IInspectable>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().get_NotationName)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(IInspectable::wrap(out)) } else { err(hr) }
    }}
}
...
impl IXmlAttribute {
    ...
    #[inline] pub fn get_specified(&self) -> Result<bool> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().get_Specified)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
...
impl IXmlCharacterData {
    ...
    #[inline] pub fn set_data(&self, value: &HStringArg) -> Result<()> { unsafe { 
        let hr = (self.get_vtbl().put_Data)(self.get_abi() as *const _ as *mut _, value.get());
        if hr == S_OK { Ok(()) } else { err(hr) }
    }}
    ...
    #[inline] pub fn substring_data(&self, offset: u32, count: u32) -> Result<HString> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().SubstringData)(self.get_abi() as *const _ as *mut _, offset, count, &mut out);
        if hr == S_OK { Ok(HString::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn append_data(&self, data: &HStringArg) -> Result<()> { unsafe { 
        let hr = (self.get_vtbl().AppendData)(self.get_abi() as *const _ as *mut _, data.get());
        if hr == S_OK { Ok(()) } else { err(hr) }
    }}
    #[inline] pub fn insert_data(&self, offset: u32, data: &HStringArg) -> Result<()> { unsafe { 
        let hr = (self.get_vtbl().InsertData)(self.get_abi() as *const _ as *mut _, offset, data.get());
        if hr == S_OK { Ok(()) } else { err(hr) }
    }}
    #[inline] pub fn delete_data(&self, offset: u32, count: u32) -> Result<()> { unsafe { 
        let hr = (self.get_vtbl().DeleteData)(self.get_abi() as *const _ as *mut _, offset, count);
        if hr == S_OK { Ok(()) } else { err(hr) }
    }}
    #[inline] pub fn replace_data(&self, offset: u32, count: u32, data: &HStringArg) -> Result<()> { unsafe { 
        let hr = (self.get_vtbl().ReplaceData)(self.get_abi() as *const _ as *mut _, offset, count, data.get());
        if hr == S_OK { Ok(()) } else { err(hr) }
    }}
}
...
impl IXmlDocument {
    #[inline] pub fn get_doctype(&self) -> Result<Option<XmlDocumentType>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().get_Doctype)(self.get_abi() as *const _ as *mut _, &mut out);
    ...
    #[inline] pub fn get_implementation(&self) -> Result<Option<XmlDomImplementation>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().get_Implementation)(self.get_abi() as *const _ as *mut _, &mut out);
    ...
    #[inline] pub fn get_document_element(&self) -> Result<Option<XmlElement>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().get_DocumentElement)(self.get_abi() as *const _ as *mut _, &mut out);
    ...
    #[inline] pub fn create_element(&self, tagName: &HStringArg) -> Result<Option<XmlElement>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().CreateElement)(self.get_abi() as *const _ as *mut _, tagName.get(), &mut out);
        if hr == S_OK { Ok(XmlElement::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn create_document_fragment(&self) -> Result<Option<XmlDocumentFragment>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().CreateDocumentFragment)(self.get_abi() as *const _ as *mut _, &mut out);
    ...
    #[inline] pub fn create_text_node(&self, data: &HStringArg) -> Result<Option<XmlText>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().CreateTextNode)(self.get_abi() as *const _ as *mut _, data.get(), &mut out);
    ...
    #[inline] pub fn create_comment(&self, data: &HStringArg) -> Result<Option<XmlComment>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().CreateComment)(self.get_abi() as *const _ as *mut _, data.get(), &mut out);
    ...
    #[inline] pub fn create_processing_instruction(&self, target: &HStringArg, data: &HStringArg) -> Result<Option<XmlProcessingInstruction>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().CreateProcessingInstruction)(self.get_abi() as *const _ as *mut _, target.get(), data.get(), &mut out);
    ...
    #[inline] pub fn create_attribute(&self, name: &HStringArg) -> Result<Option<XmlAttribute>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().CreateAttribute)(self.get_abi() as *const _ as *mut _, name.get(), &mut out);
    ...
    #[inline] pub fn create_entity_reference(&self, name: &HStringArg) -> Result<Option<XmlEntityReference>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().CreateEntityReference)(self.get_abi() as *const _ as *mut _, name.get(), &mut out);
    ...
    #[inline] pub fn get_elements_by_tag_name(&self, tagName: &HStringArg) -> Result<Option<XmlNodeList>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().GetElementsByTagName)(self.get_abi() as *const _ as *mut _, tagName.get(), &mut out);
    ...
    #[inline] pub fn create_cdata_section(&self, data: &HStringArg) -> Result<Option<XmlCDataSection>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().CreateCDataSection)(self.get_abi() as *const _ as *mut _, data.get(), &mut out);
        if hr == S_OK { Ok(XmlCDataSection::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_document_uri(&self) -> Result<HString> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().get_DocumentUri)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(HString::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn create_attribute_ns(&self, namespaceUri: &IInspectable, qualifiedName: &HStringArg) -> Result<Option<XmlAttribute>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().CreateAttributeNS)(self.get_abi() as *const _ as *mut _, namespaceUri.get_abi() as *const _ as *mut _, qualifiedName.get(), &mut out);
        if hr == S_OK { Ok(XmlAttribute::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn create_element_ns(&self, namespaceUri: &IInspectable, qualifiedName: &HStringArg) -> Result<Option<XmlElement>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().CreateElementNS)(self.get_abi() as *const _ as *mut _, namespaceUri.get_abi() as *const _ as *mut _, qualifiedName.get(), &mut out);
        if hr == S_OK { Ok(XmlElement::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_element_by_id(&self, elementId: &HStringArg) -> Result<Option<XmlElement>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().GetElementById)(self.get_abi() as *const _ as *mut _, elementId.get(), &mut out);
        if hr == S_OK { Ok(XmlElement::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn import_node(&self, node: &IXmlNode, deep: bool) -> Result<Option<IXmlNode>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().ImportNode)(self.get_abi() as *const _ as *mut _, node.get_abi() as *const _ as *mut _, deep, &mut out);
...
impl IXmlDocumentIO {
    #[inline] pub fn load_xml(&self, xml: &HStringArg) -> Result<()> { unsafe { 
        let hr = (self.get_vtbl().LoadXml)(self.get_abi() as *const _ as *mut _, xml.get());
        if hr == S_OK { Ok(()) } else { err(hr) }
    }}
    #[inline] pub fn load_xml_with_settings(&self, xml: &HStringArg, loadSettings: &XmlLoadSettings) -> Result<()> { unsafe { 
        let hr = (self.get_vtbl().LoadXmlWithSettings)(self.get_abi() as *const _ as *mut _, xml.get(), loadSettings.get_abi() as *const _ as *mut _);
        if hr == S_OK { Ok(()) } else { err(hr) }
    }}
    #[cfg(feature="windows-storage")] #[inline] pub fn save_to_file_async(&self, file: &crate::windows::storage::IStorageFile) -> Result<foundation::IAsyncAction> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().SaveToFileAsync)(self.get_abi() as *const _ as *mut _, file.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(foundation::IAsyncAction::wrap_nonnull(out)) } else { err(hr) }
    }}
}
...
impl IXmlDocumentIO2 {
    #[cfg(feature="windows-storage")] #[inline] pub fn load_xml_from_buffer(&self, buffer: &crate::windows::storage::streams::IBuffer) -> Result<()> { unsafe { 
        let hr = (self.get_vtbl().LoadXmlFromBuffer)(self.get_abi() as *const _ as *mut _, buffer.get_abi() as *const _ as *mut _);
        if hr == S_OK { Ok(()) } else { err(hr) }
    }}
    #[cfg(feature="windows-storage")] #[inline] pub fn load_xml_from_buffer_with_settings(&self, buffer: &crate::windows::storage::streams::IBuffer, loadSettings: &XmlLoadSettings) -> Result<()> { unsafe { 
        let hr = (self.get_vtbl().LoadXmlFromBufferWithSettings)(self.get_abi() as *const _ as *mut _, buffer.get_abi() as *const _ as *mut _, loadSettings.get_abi() as *const _ as *mut _);
        if hr == S_OK { Ok(()) } else { err(hr) }
    }}
}
...
impl IXmlDocumentStatics {
    #[inline] pub fn load_from_uri_async(&self, uri: &foundation::Uri) -> Result<foundation::IAsyncOperation<XmlDocument>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().LoadFromUriAsync)(self.get_abi() as *const _ as *mut _, uri.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(foundation::IAsyncOperation::wrap_nonnull(out)) } else { err(hr) }
    }}
    #[inline] pub fn load_from_uri_with_settings_async(&self, uri: &foundation::Uri, loadSettings: &XmlLoadSettings) -> Result<foundation::IAsyncOperation<XmlDocument>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().LoadFromUriWithSettingsAsync)(self.get_abi() as *const _ as *mut _, uri.get_abi() as *const _ as *mut _, loadSettings.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(foundation::IAsyncOperation::wrap_nonnull(out)) } else { err(hr) }
    }}
    ...
    #[cfg(feature="windows-storage")] #[inline] pub fn load_from_file_with_settings_async(&self, file: &crate::windows::storage::IStorageFile, loadSettings: &XmlLoadSettings) -> Result<foundation::IAsyncOperation<XmlDocument>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().LoadFromFileWithSettingsAsync)(self.get_abi() as *const _ as *mut _, file.get_abi() as *const _ as *mut _, loadSettings.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(foundation::IAsyncOperation::wrap_nonnull(out)) } else { err(hr) }
    }}
}
...
impl IXmlDocumentType {
    ...
    #[inline] pub fn get_entities(&self) -> Result<Option<XmlNamedNodeMap>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().get_Entities)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(XmlNamedNodeMap::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_notations(&self) -> Result<Option<XmlNamedNodeMap>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().get_Notations)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(XmlNamedNodeMap::wrap(out)) } else { err(hr) }
    }}
}
...
impl IXmlDomImplementation {
    #[inline] pub fn has_feature(&self, feature: &HStringArg, version: &IInspectable) -> Result<bool> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().HasFeature)(self.get_abi() as *const _ as *mut _, feature.get(), version.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
}
...
impl IXmlElement {
    #[inline] pub fn get_tag_name(&self) -> Result<HString> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().get_TagName)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(HString::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_attribute(&self, attributeName: &HStringArg) -> Result<HString> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().GetAttribute)(self.get_abi() as *const _ as *mut _, attributeName.get(), &mut out);
        if hr == S_OK { Ok(HString::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn set_attribute(&self, attributeName: &HStringArg, attributeValue: &HStringArg) -> Result<()> { unsafe { 
        let hr = (self.get_vtbl().SetAttribute)(self.get_abi() as *const _ as *mut _, attributeName.get(), attributeValue.get());
        if hr == S_OK { Ok(()) } else { err(hr) }
    }}
    #[inline] pub fn remove_attribute(&self, attributeName: &HStringArg) -> Result<()> { unsafe { 
        let hr = (self.get_vtbl().RemoveAttribute)(self.get_abi() as *const _ as *mut _, attributeName.get());
        if hr == S_OK { Ok(()) } else { err(hr) }
    }}
    #[inline] pub fn get_attribute_node(&self, attributeName: &HStringArg) -> Result<Option<XmlAttribute>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().GetAttributeNode)(self.get_abi() as *const _ as *mut _, attributeName.get(), &mut out);
        if hr == S_OK { Ok(XmlAttribute::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn set_attribute_node(&self, newAttribute: &XmlAttribute) -> Result<Option<XmlAttribute>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().SetAttributeNode)(self.get_abi() as *const _ as *mut _, newAttribute.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(XmlAttribute::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn remove_attribute_node(&self, attributeNode: &XmlAttribute) -> Result<Option<XmlAttribute>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().RemoveAttributeNode)(self.get_abi() as *const _ as *mut _, attributeNode.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(XmlAttribute::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_elements_by_tag_name(&self, tagName: &HStringArg) -> Result<Option<XmlNodeList>> { unsafe { 
        let mut out = null_mut();
    ...
    #[inline] pub fn set_attribute_ns(&self, namespaceUri: &IInspectable, qualifiedName: &HStringArg, value: &HStringArg) -> Result<()> { unsafe { 
        let hr = (self.get_vtbl().SetAttributeNS)(self.get_abi() as *const _ as *mut _, namespaceUri.get_abi() as *const _ as *mut _, qualifiedName.get(), value.get());
        if hr == S_OK { Ok(()) } else { err(hr) }
    }}
    #[inline] pub fn get_attribute_ns(&self, namespaceUri: &IInspectable, localName: &HStringArg) -> Result<HString> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().GetAttributeNS)(self.get_abi() as *const _ as *mut _, namespaceUri.get_abi() as *const _ as *mut _, localName.get(), &mut out);
        if hr == S_OK { Ok(HString::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn remove_attribute_ns(&self, namespaceUri: &IInspectable, localName: &HStringArg) -> Result<()> { unsafe { 
        let hr = (self.get_vtbl().RemoveAttributeNS)(self.get_abi() as *const _ as *mut _, namespaceUri.get_abi() as *const _ as *mut _, localName.get());
        if hr == S_OK { Ok(()) } else { err(hr) }
    }}
    #[inline] pub fn set_attribute_node_ns(&self, newAttribute: &XmlAttribute) -> Result<Option<XmlAttribute>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().SetAttributeNodeNS)(self.get_abi() as *const _ as *mut _, newAttribute.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(XmlAttribute::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_attribute_node_ns(&self, namespaceUri: &IInspectable, localName: &HStringArg) -> Result<Option<XmlAttribute>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().GetAttributeNodeNS)(self.get_abi() as *const _ as *mut _, namespaceUri.get_abi() as *const _ as *mut _, localName.get(), &mut out);
        if hr == S_OK { Ok(XmlAttribute::wrap(out)) } else { err(hr) }
    }}
}
...
impl IXmlLoadSettings {
    #[inline] pub fn get_max_element_depth(&self) -> Result<u32> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().get_MaxElementDepth)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn set_max_element_depth(&self, value: u32) -> Result<()> { unsafe { 
        let hr = (self.get_vtbl().put_MaxElementDepth)(self.get_abi() as *const _ as *mut _, value);
        if hr == S_OK { Ok(()) } else { err(hr) }
    }}
    #[inline] pub fn get_prohibit_dtd(&self) -> Result<bool> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().get_ProhibitDtd)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn set_prohibit_dtd(&self, value: bool) -> Result<()> { unsafe { 
        let hr = (self.get_vtbl().put_ProhibitDtd)(self.get_abi() as *const _ as *mut _, value);
        if hr == S_OK { Ok(()) } else { err(hr) }
    }}
    #[inline] pub fn get_resolve_externals(&self) -> Result<bool> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().get_ResolveExternals)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn set_resolve_externals(&self, value: bool) -> Result<()> { unsafe { 
        let hr = (self.get_vtbl().put_ResolveExternals)(self.get_abi() as *const _ as *mut _, value);
        if hr == S_OK { Ok(()) } else { err(hr) }
    }}
    #[inline] pub fn get_validate_on_parse(&self) -> Result<bool> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().get_ValidateOnParse)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn set_validate_on_parse(&self, value: bool) -> Result<()> { unsafe { 
        let hr = (self.get_vtbl().put_ValidateOnParse)(self.get_abi() as *const _ as *mut _, value);
        if hr == S_OK { Ok(()) } else { err(hr) }
    }}
    #[inline] pub fn get_element_content_white_space(&self) -> Result<bool> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().get_ElementContentWhiteSpace)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn set_element_content_white_space(&self, value: bool) -> Result<()> { unsafe { 
        let hr = (self.get_vtbl().put_ElementContentWhiteSpace)(self.get_abi() as *const _ as *mut _, value);
        if hr == S_OK { Ok(()) } else { err(hr) }
    }}
}
...
impl IXmlNamedNodeMap {
    ...
    #[inline] pub fn item(&self, index: u32) -> Result<Option<IXmlNode>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().Item)(self.get_abi() as *const _ as *mut _, index, &mut out);
        if hr == S_OK { Ok(IXmlNode::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_named_item(&self, name: &HStringArg) -> Result<Option<IXmlNode>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().GetNamedItem)(self.get_abi() as *const _ as *mut _, name.get(), &mut out);
        if hr == S_OK { Ok(IXmlNode::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn set_named_item(&self, node: &IXmlNode) -> Result<Option<IXmlNode>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().SetNamedItem)(self.get_abi() as *const _ as *mut _, node.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(IXmlNode::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn remove_named_item(&self, name: &HStringArg) -> Result<Option<IXmlNode>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().RemoveNamedItem)(self.get_abi() as *const _ as *mut _, name.get(), &mut out);
        if hr == S_OK { Ok(IXmlNode::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_named_item_ns(&self, namespaceUri: &IInspectable, name: &HStringArg) -> Result<Option<IXmlNode>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().GetNamedItemNS)(self.get_abi() as *const _ as *mut _, namespaceUri.get_abi() as *const _ as *mut _, name.get(), &mut out);
        if hr == S_OK { Ok(IXmlNode::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn remove_named_item_ns(&self, namespaceUri: &IInspectable, name: &HStringArg) -> Result<Option<IXmlNode>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().RemoveNamedItemNS)(self.get_abi() as *const _ as *mut _, namespaceUri.get_abi() as *const _ as *mut _, name.get(), &mut out);
        if hr == S_OK { Ok(IXmlNode::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn set_named_item_ns(&self, node: &IXmlNode) -> Result<Option<IXmlNode>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().SetNamedItemNS)(self.get_abi() as *const _ as *mut _, node.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(IXmlNode::wrap(out)) } else { err(hr) }
    }}
}
...
impl IXmlNode {
    ...
    #[inline] pub fn set_node_value(&self, value: &IInspectable) -> Result<()> { unsafe { 
        let hr = (self.get_vtbl().put_NodeValue)(self.get_abi() as *const _ as *mut _, value.get_abi() as *const _ as *mut _);
        if hr == S_OK { Ok(()) } else { err(hr) }
    }}
    #[inline] pub fn get_node_type(&self) -> Result<NodeType> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().get_NodeType)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    ...
    #[inline] pub fn get_parent_node(&self) -> Result<Option<IXmlNode>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().get_ParentNode)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(IXmlNode::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_child_nodes(&self) -> Result<Option<XmlNodeList>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().get_ChildNodes)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(XmlNodeList::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_first_child(&self) -> Result<Option<IXmlNode>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().get_FirstChild)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(IXmlNode::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_last_child(&self) -> Result<Option<IXmlNode>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().get_LastChild)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(IXmlNode::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_previous_sibling(&self) -> Result<Option<IXmlNode>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().get_PreviousSibling)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(IXmlNode::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_next_sibling(&self) -> Result<Option<IXmlNode>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().get_NextSibling)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(IXmlNode::wrap(out)) } else { err(hr) }
    }}
    ...
    #[inline] pub fn has_child_nodes(&self) -> Result<bool> { unsafe { 
        let mut out = zeroed();
        let hr = (self.get_vtbl().HasChildNodes)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }}
    #[inline] pub fn get_owner_document(&self) -> Result<Option<XmlDocument>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().get_OwnerDocument)(self.get_abi() as *const _ as *mut _, &mut out);
    ...
    #[inline] pub fn insert_before(&self, newChild: &IXmlNode, referenceChild: &IXmlNode) -> Result<Option<IXmlNode>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().InsertBefore)(self.get_abi() as *const _ as *mut _, newChild.get_abi() as *const _ as *mut _, referenceChild.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(IXmlNode::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn replace_child(&self, newChild: &IXmlNode, referenceChild: &IXmlNode) -> Result<Option<IXmlNode>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().ReplaceChild)(self.get_abi() as *const _ as *mut _, newChild.get_abi() as *const _ as *mut _, referenceChild.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(IXmlNode::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn remove_child(&self, childNode: &IXmlNode) -> Result<Option<IXmlNode>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().RemoveChild)(self.get_abi() as *const _ as *mut _, childNode.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(IXmlNode::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn append_child(&self, newChild: &IXmlNode) -> Result<Option<IXmlNode>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().AppendChild)(self.get_abi() as *const _ as *mut _, newChild.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(IXmlNode::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn clone_node(&self, deep: bool) -> Result<Option<IXmlNode>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().CloneNode)(self.get_abi() as *const _ as *mut _, deep, &mut out);
        if hr == S_OK { Ok(IXmlNode::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_namespace_uri(&self) -> Result<Option<IInspectable>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().get_NamespaceUri)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(IInspectable::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_local_name(&self) -> Result<Option<IInspectable>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().get_LocalName)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(IInspectable::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_prefix(&self) -> Result<Option<IInspectable>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().get_Prefix)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(IInspectable::wrap(out)) } else { err(hr) }
    }}
    ...
    #[inline] pub fn set_prefix(&self, value: &IInspectable) -> Result<()> { unsafe { 
        let hr = (self.get_vtbl().put_Prefix)(self.get_abi() as *const _ as *mut _, value.get_abi() as *const _ as *mut _);
        if hr == S_OK { Ok(()) } else { err(hr) }
    }}
}
...
impl IXmlNodeSelector {
    #[inline] pub fn select_single_node(&self, xpath: &HStringArg) -> Result<Option<IXmlNode>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().SelectSingleNode)(self.get_abi() as *const _ as *mut _, xpath.get(), &mut out);
        if hr == S_OK { Ok(IXmlNode::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn select_nodes(&self, xpath: &HStringArg) -> Result<Option<XmlNodeList>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().SelectNodes)(self.get_abi() as *const _ as *mut _, xpath.get(), &mut out);
        if hr == S_OK { Ok(XmlNodeList::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn select_single_node_ns(&self, xpath: &HStringArg, namespaces: &IInspectable) -> Result<Option<IXmlNode>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().SelectSingleNodeNS)(self.get_abi() as *const _ as *mut _, xpath.get(), namespaces.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(IXmlNode::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn select_nodes_ns(&self, xpath: &HStringArg, namespaces: &IInspectable) -> Result<Option<XmlNodeList>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().SelectNodesNS)(self.get_abi() as *const _ as *mut _, xpath.get(), namespaces.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(XmlNodeList::wrap(out)) } else { err(hr) }
    }}
}
...
impl IXmlNodeSerializer {
    #[inline] pub fn get_xml(&self) -> Result<HString> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().GetXml)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(HString::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_inner_text(&self) -> Result<HString> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().get_InnerText)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(HString::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn set_inner_text(&self, value: &HStringArg) -> Result<()> { unsafe { 
        let hr = (self.get_vtbl().put_InnerText)(self.get_abi() as *const _ as *mut _, value.get());
        if hr == S_OK { Ok(()) } else { err(hr) }
    }}
}
...
impl IXmlProcessingInstruction {
    #[inline] pub fn get_target(&self) -> Result<HString> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().get_Target)(self.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(HString::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn get_data(&self) -> Result<HString> { unsafe { 
        let mut out = null_mut();
...
impl IXmlText {
    #[inline] pub fn split_text(&self, offset: u32) -> Result<Option<IXmlText>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().SplitText)(self.get_abi() as *const _ as *mut _, offset, &mut out);
...
impl IXsltProcessor {
    #[inline] pub fn transform_to_string(&self, inputNode: &super::dom::IXmlNode) -> Result<HString> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().TransformToString)(self.get_abi() as *const _ as *mut _, inputNode.get_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(HString::wrap(out)) } else { err(hr) }
    }}
}
...
impl IXsltProcessor2 {
    #[inline] pub fn transform_to_document(&self, inputNode: &super::dom::IXmlNode) -> Result<Option<super::dom::XmlDocument>> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().TransformToDocument)(self.get_abi() as *const _ as *mut _, inputNode.get_abi() as *const _ as *mut _, &mut out);
...
impl IXsltProcessorFactory {
    #[inline] pub fn create_instance(&self, document: &super::dom::XmlDocument) -> Result<XsltProcessor> { unsafe { 
        let mut out = null_mut();
        let hr = (self.get_vtbl().CreateInstance)(self.get_abi() as *const _ as *mut _, document.get_abi() as *const _ as *mut _, &mut out);
