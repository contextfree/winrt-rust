...
impl LearningModel {
    ...
    #[cfg(feature="windows-storage")] #[inline] pub fn load_from_stream(modelStream: &ComPtr<super::super::storage::streams::IRandomAccessStreamReference>) -> Result<Option<LearningModel>> {
    ...
    #[inline] pub fn load_from_file_path_with_operator_provider(filePath: &HStringArg, operatorProvider: &ComPtr<ILearningModelOperatorProvider>) -> Result<Option<LearningModel>> {
    ...
    #[cfg(feature="windows-storage")] #[inline] pub fn load_from_stream_with_operator_provider(modelStream: &ComPtr<super::super::storage::streams::IRandomAccessStreamReference>, operatorProvider: &ComPtr<ILearningModelOperatorProvider>) -> Result<Option<LearningModel>> {
...
impl LearningModelDevice {
    ...
    #[cfg(feature="windows-graphics")] #[inline] pub fn create_from_direct3d11_device(device: &ComPtr<super::super::graphics::directx::direct3d11::IDirect3DDevice>) -> Result<Option<LearningModelDevice>> {
...
RT_INTERFACE!{static interface ILearningModelDeviceStatics(ILearningModelDeviceStaticsVtbl): IInspectable(IInspectableVtbl) [IID_ILearningModelDeviceStatics] {
    #[cfg(feature="windows-graphics")] fn CreateFromDirect3D11Device(&self, device: *mut super::super::graphics::directx::direct3d11::IDirect3DDevice, out: *mut <LearningModelDevice as RtType>::Abi) -> HRESULT
}}
impl ComPtr<ILearningModelDeviceStatics> {
    #[cfg(feature="windows-graphics")] #[inline] pub fn create_from_direct3d11_device(&self, device: &ComPtr<super::super::graphics::directx::direct3d11::IDirect3DDevice>) -> Result<Option<LearningModelDevice>> { unsafe { 
        let mut out = null_mut();
...
RT_INTERFACE!{interface ILearningModelSession(ILearningModelSessionVtbl): IInspectable(IInspectableVtbl) [IID_ILearningModelSession] {
    ...
    fn EvaluateAsync(&self, bindings: <LearningModelBinding as RtType>::Abi, correlationId: HSTRING, out: *mut *mut foundation::IAsyncOperation<LearningModelEvaluationResult>) -> HRESULT,
    ...
    fn EvaluateFeatures(&self, features: *mut foundation::collections::IMap<HString, IInspectable>, correlationId: HSTRING, out: *mut <LearningModelEvaluationResult as RtType>::Abi) -> HRESULT
}}
impl ComPtr<ILearningModelSession> {
    ...
    #[inline] pub fn evaluate_async(&self, bindings: &LearningModelBinding, correlationId: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<LearningModelEvaluationResult>>> { unsafe { 
        let mut out = null_mut();
    ...
    #[inline] pub fn evaluate_features(&self, features: &ComPtr<foundation::collections::IMap<HString, IInspectable>>, correlationId: &HStringArg) -> Result<Option<LearningModelEvaluationResult>> { unsafe { 
        let mut out = null_mut();
...
RT_INTERFACE!{static interface ILearningModelStatics(ILearningModelStaticsVtbl): IInspectable(IInspectableVtbl) [IID_ILearningModelStatics] {
    ...
    #[cfg(feature="windows-storage")] fn LoadFromStream(&self, modelStream: *mut super::super::storage::streams::IRandomAccessStreamReference, out: *mut <LearningModel as RtType>::Abi) -> HRESULT,
    ...
    fn LoadFromFilePathWithOperatorProvider(&self, filePath: HSTRING, operatorProvider: *mut ILearningModelOperatorProvider, out: *mut <LearningModel as RtType>::Abi) -> HRESULT,
    #[cfg(feature="windows-storage")] fn LoadFromStreamWithOperatorProvider(&self, modelStream: *mut super::super::storage::streams::IRandomAccessStreamReference, operatorProvider: *mut ILearningModelOperatorProvider, out: *mut <LearningModel as RtType>::Abi) -> HRESULT
}}
impl ComPtr<ILearningModelStatics> {
    ...
    #[cfg(feature="windows-storage")] #[inline] pub fn load_from_stream(&self, modelStream: &ComPtr<super::super::storage::streams::IRandomAccessStreamReference>) -> Result<Option<LearningModel>> { unsafe { 
        let mut out = null_mut();
    ...
    #[inline] pub fn load_from_file_path_with_operator_provider(&self, filePath: &HStringArg, operatorProvider: &ComPtr<ILearningModelOperatorProvider>) -> Result<Option<LearningModel>> { unsafe { 
        let mut out = null_mut();
    ...
    #[cfg(feature="windows-storage")] #[inline] pub fn load_from_stream_with_operator_provider(&self, modelStream: &ComPtr<super::super::storage::streams::IRandomAccessStreamReference>, operatorProvider: &ComPtr<ILearningModelOperatorProvider>) -> Result<Option<LearningModel>> { unsafe { 
        let mut out = null_mut();
...
impl TensorBoolean {
    ...
    #[inline] pub fn create2(shape: &ComPtr<foundation::collections::IIterable<i64>>) -> Result<Option<TensorBoolean>> {
        <Self as RtActivatable<ITensorBooleanStatics>>::get_activation_factory().create2(shape)
    }
    #[inline] pub fn create_from_array(shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &[bool]) -> Result<Option<TensorBoolean>> {
        <Self as RtActivatable<ITensorBooleanStatics>>::get_activation_factory().create_from_array(shape, data)
    }
    #[inline] pub fn create_from_iterable(shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &ComPtr<foundation::collections::IIterable<bool>>) -> Result<Option<TensorBoolean>> {
...
RT_INTERFACE!{static interface ITensorBooleanStatics(ITensorBooleanStaticsVtbl): IInspectable(IInspectableVtbl) [IID_ITensorBooleanStatics] {
    ...
    fn Create2(&self, shape: *mut foundation::collections::IIterable<i64>, out: *mut <TensorBoolean as RtType>::Abi) -> HRESULT,
    fn CreateFromArray(&self, shape: *mut foundation::collections::IIterable<i64>, dataSize: u32, data: *mut bool, out: *mut <TensorBoolean as RtType>::Abi) -> HRESULT,
    fn CreateFromIterable(&self, shape: *mut foundation::collections::IIterable<i64>, data: *mut foundation::collections::IIterable<bool>, out: *mut <TensorBoolean as RtType>::Abi) -> HRESULT
}}
impl ComPtr<ITensorBooleanStatics> {
    ...
    #[inline] pub fn create2(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>) -> Result<Option<TensorBoolean>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).Create2)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(TensorBoolean::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn create_from_array(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &[bool]) -> Result<Option<TensorBoolean>> { unsafe { 
        let mut out = null_mut();
    ...
    #[inline] pub fn create_from_iterable(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &ComPtr<foundation::collections::IIterable<bool>>) -> Result<Option<TensorBoolean>> { unsafe { 
        let mut out = null_mut();
...
impl TensorDouble {
    ...
    #[inline] pub fn create2(shape: &ComPtr<foundation::collections::IIterable<i64>>) -> Result<Option<TensorDouble>> {
        <Self as RtActivatable<ITensorDoubleStatics>>::get_activation_factory().create2(shape)
    }
    #[inline] pub fn create_from_array(shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &[f64]) -> Result<Option<TensorDouble>> {
        <Self as RtActivatable<ITensorDoubleStatics>>::get_activation_factory().create_from_array(shape, data)
    }
    #[inline] pub fn create_from_iterable(shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &ComPtr<foundation::collections::IIterable<f64>>) -> Result<Option<TensorDouble>> {
...
RT_INTERFACE!{static interface ITensorDoubleStatics(ITensorDoubleStaticsVtbl): IInspectable(IInspectableVtbl) [IID_ITensorDoubleStatics] {
    ...
    fn Create2(&self, shape: *mut foundation::collections::IIterable<i64>, out: *mut <TensorDouble as RtType>::Abi) -> HRESULT,
    fn CreateFromArray(&self, shape: *mut foundation::collections::IIterable<i64>, dataSize: u32, data: *mut f64, out: *mut <TensorDouble as RtType>::Abi) -> HRESULT,
    fn CreateFromIterable(&self, shape: *mut foundation::collections::IIterable<i64>, data: *mut foundation::collections::IIterable<f64>, out: *mut <TensorDouble as RtType>::Abi) -> HRESULT
}}
impl ComPtr<ITensorDoubleStatics> {
    ...
    #[inline] pub fn create2(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>) -> Result<Option<TensorDouble>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).Create2)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(TensorDouble::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn create_from_array(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &[f64]) -> Result<Option<TensorDouble>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).CreateFromArray)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, data.len() as u32, data.as_ptr() as *mut _, &mut out);
        if hr == S_OK { Ok(TensorDouble::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn create_from_iterable(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &ComPtr<foundation::collections::IIterable<f64>>) -> Result<Option<TensorDouble>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).CreateFromIterable)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, data.as_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(TensorDouble::wrap(out)) } else { err(hr) }
    }}
...
impl TensorFloat {
    ...
    #[inline] pub fn create2(shape: &ComPtr<foundation::collections::IIterable<i64>>) -> Result<Option<TensorFloat>> {
        <Self as RtActivatable<ITensorFloatStatics>>::get_activation_factory().create2(shape)
    }
    #[inline] pub fn create_from_array(shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &[f32]) -> Result<Option<TensorFloat>> {
        <Self as RtActivatable<ITensorFloatStatics>>::get_activation_factory().create_from_array(shape, data)
    }
    #[inline] pub fn create_from_iterable(shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &ComPtr<foundation::collections::IIterable<f32>>) -> Result<Option<TensorFloat>> {
...
impl TensorFloat16Bit {
    ...
    #[inline] pub fn create2(shape: &ComPtr<foundation::collections::IIterable<i64>>) -> Result<Option<TensorFloat16Bit>> {
        <Self as RtActivatable<ITensorFloat16BitStatics>>::get_activation_factory().create2(shape)
    }
    #[inline] pub fn create_from_array(shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &[f32]) -> Result<Option<TensorFloat16Bit>> {
        <Self as RtActivatable<ITensorFloat16BitStatics>>::get_activation_factory().create_from_array(shape, data)
    }
    #[inline] pub fn create_from_iterable(shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &ComPtr<foundation::collections::IIterable<f32>>) -> Result<Option<TensorFloat16Bit>> {
...
RT_INTERFACE!{static interface ITensorFloat16BitStatics(ITensorFloat16BitStaticsVtbl): IInspectable(IInspectableVtbl) [IID_ITensorFloat16BitStatics] {
    ...
    fn Create2(&self, shape: *mut foundation::collections::IIterable<i64>, out: *mut <TensorFloat16Bit as RtType>::Abi) -> HRESULT,
    fn CreateFromArray(&self, shape: *mut foundation::collections::IIterable<i64>, dataSize: u32, data: *mut f32, out: *mut <TensorFloat16Bit as RtType>::Abi) -> HRESULT,
    fn CreateFromIterable(&self, shape: *mut foundation::collections::IIterable<i64>, data: *mut foundation::collections::IIterable<f32>, out: *mut <TensorFloat16Bit as RtType>::Abi) -> HRESULT
}}
impl ComPtr<ITensorFloat16BitStatics> {
    ...
    #[inline] pub fn create2(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>) -> Result<Option<TensorFloat16Bit>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).Create2)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(TensorFloat16Bit::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn create_from_array(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &[f32]) -> Result<Option<TensorFloat16Bit>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).CreateFromArray)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, data.len() as u32, data.as_ptr() as *mut _, &mut out);
        if hr == S_OK { Ok(TensorFloat16Bit::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn create_from_iterable(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &ComPtr<foundation::collections::IIterable<f32>>) -> Result<Option<TensorFloat16Bit>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).CreateFromIterable)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, data.as_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(TensorFloat16Bit::wrap(out)) } else { err(hr) }
    }}
...
RT_INTERFACE!{static interface ITensorFloatStatics(ITensorFloatStaticsVtbl): IInspectable(IInspectableVtbl) [IID_ITensorFloatStatics] {
    ...
    fn Create2(&self, shape: *mut foundation::collections::IIterable<i64>, out: *mut <TensorFloat as RtType>::Abi) -> HRESULT,
    fn CreateFromArray(&self, shape: *mut foundation::collections::IIterable<i64>, dataSize: u32, data: *mut f32, out: *mut <TensorFloat as RtType>::Abi) -> HRESULT,
    fn CreateFromIterable(&self, shape: *mut foundation::collections::IIterable<i64>, data: *mut foundation::collections::IIterable<f32>, out: *mut <TensorFloat as RtType>::Abi) -> HRESULT
}}
impl ComPtr<ITensorFloatStatics> {
    ...
    #[inline] pub fn create2(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>) -> Result<Option<TensorFloat>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).Create2)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(TensorFloat::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn create_from_array(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &[f32]) -> Result<Option<TensorFloat>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).CreateFromArray)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, data.len() as u32, data.as_ptr() as *mut _, &mut out);
        if hr == S_OK { Ok(TensorFloat::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn create_from_iterable(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &ComPtr<foundation::collections::IIterable<f32>>) -> Result<Option<TensorFloat>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).CreateFromIterable)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, data.as_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(TensorFloat::wrap(out)) } else { err(hr) }
    }}
...
impl TensorInt16Bit {
    ...
    #[inline] pub fn create2(shape: &ComPtr<foundation::collections::IIterable<i64>>) -> Result<Option<TensorInt16Bit>> {
        <Self as RtActivatable<ITensorInt16BitStatics>>::get_activation_factory().create2(shape)
    }
    #[inline] pub fn create_from_array(shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &[i16]) -> Result<Option<TensorInt16Bit>> {
        <Self as RtActivatable<ITensorInt16BitStatics>>::get_activation_factory().create_from_array(shape, data)
    }
    #[inline] pub fn create_from_iterable(shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &ComPtr<foundation::collections::IIterable<i16>>) -> Result<Option<TensorInt16Bit>> {
...
RT_INTERFACE!{static interface ITensorInt16BitStatics(ITensorInt16BitStaticsVtbl): IInspectable(IInspectableVtbl) [IID_ITensorInt16BitStatics] {
    ...
    fn Create2(&self, shape: *mut foundation::collections::IIterable<i64>, out: *mut <TensorInt16Bit as RtType>::Abi) -> HRESULT,
    fn CreateFromArray(&self, shape: *mut foundation::collections::IIterable<i64>, dataSize: u32, data: *mut i16, out: *mut <TensorInt16Bit as RtType>::Abi) -> HRESULT,
    fn CreateFromIterable(&self, shape: *mut foundation::collections::IIterable<i64>, data: *mut foundation::collections::IIterable<i16>, out: *mut <TensorInt16Bit as RtType>::Abi) -> HRESULT
}}
impl ComPtr<ITensorInt16BitStatics> {
    ...
    #[inline] pub fn create2(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>) -> Result<Option<TensorInt16Bit>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).Create2)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(TensorInt16Bit::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn create_from_array(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &[i16]) -> Result<Option<TensorInt16Bit>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).CreateFromArray)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, data.len() as u32, data.as_ptr() as *mut _, &mut out);
        if hr == S_OK { Ok(TensorInt16Bit::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn create_from_iterable(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &ComPtr<foundation::collections::IIterable<i16>>) -> Result<Option<TensorInt16Bit>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).CreateFromIterable)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, data.as_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(TensorInt16Bit::wrap(out)) } else { err(hr) }
    }}
...
impl TensorInt32Bit {
    ...
    #[inline] pub fn create2(shape: &ComPtr<foundation::collections::IIterable<i64>>) -> Result<Option<TensorInt32Bit>> {
        <Self as RtActivatable<ITensorInt32BitStatics>>::get_activation_factory().create2(shape)
    }
    #[inline] pub fn create_from_array(shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &[i32]) -> Result<Option<TensorInt32Bit>> {
        <Self as RtActivatable<ITensorInt32BitStatics>>::get_activation_factory().create_from_array(shape, data)
    }
    #[inline] pub fn create_from_iterable(shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &ComPtr<foundation::collections::IIterable<i32>>) -> Result<Option<TensorInt32Bit>> {
...
RT_INTERFACE!{static interface ITensorInt32BitStatics(ITensorInt32BitStaticsVtbl): IInspectable(IInspectableVtbl) [IID_ITensorInt32BitStatics] {
    ...
    fn Create2(&self, shape: *mut foundation::collections::IIterable<i64>, out: *mut <TensorInt32Bit as RtType>::Abi) -> HRESULT,
    fn CreateFromArray(&self, shape: *mut foundation::collections::IIterable<i64>, dataSize: u32, data: *mut i32, out: *mut <TensorInt32Bit as RtType>::Abi) -> HRESULT,
    fn CreateFromIterable(&self, shape: *mut foundation::collections::IIterable<i64>, data: *mut foundation::collections::IIterable<i32>, out: *mut <TensorInt32Bit as RtType>::Abi) -> HRESULT
}}
impl ComPtr<ITensorInt32BitStatics> {
    ...
    #[inline] pub fn create2(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>) -> Result<Option<TensorInt32Bit>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).Create2)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(TensorInt32Bit::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn create_from_array(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &[i32]) -> Result<Option<TensorInt32Bit>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).CreateFromArray)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, data.len() as u32, data.as_ptr() as *mut _, &mut out);
        if hr == S_OK { Ok(TensorInt32Bit::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn create_from_iterable(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &ComPtr<foundation::collections::IIterable<i32>>) -> Result<Option<TensorInt32Bit>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).CreateFromIterable)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, data.as_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(TensorInt32Bit::wrap(out)) } else { err(hr) }
    }}
...
impl TensorInt64Bit {
    ...
    #[inline] pub fn create2(shape: &ComPtr<foundation::collections::IIterable<i64>>) -> Result<Option<TensorInt64Bit>> {
        <Self as RtActivatable<ITensorInt64BitStatics>>::get_activation_factory().create2(shape)
    }
    #[inline] pub fn create_from_array(shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &[i64]) -> Result<Option<TensorInt64Bit>> {
        <Self as RtActivatable<ITensorInt64BitStatics>>::get_activation_factory().create_from_array(shape, data)
    }
    #[inline] pub fn create_from_iterable(shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &ComPtr<foundation::collections::IIterable<i64>>) -> Result<Option<TensorInt64Bit>> {
...
RT_INTERFACE!{static interface ITensorInt64BitStatics(ITensorInt64BitStaticsVtbl): IInspectable(IInspectableVtbl) [IID_ITensorInt64BitStatics] {
    ...
    fn Create2(&self, shape: *mut foundation::collections::IIterable<i64>, out: *mut <TensorInt64Bit as RtType>::Abi) -> HRESULT,
    fn CreateFromArray(&self, shape: *mut foundation::collections::IIterable<i64>, dataSize: u32, data: *mut i64, out: *mut <TensorInt64Bit as RtType>::Abi) -> HRESULT,
    fn CreateFromIterable(&self, shape: *mut foundation::collections::IIterable<i64>, data: *mut foundation::collections::IIterable<i64>, out: *mut <TensorInt64Bit as RtType>::Abi) -> HRESULT
}}
impl ComPtr<ITensorInt64BitStatics> {
    ...
    #[inline] pub fn create2(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>) -> Result<Option<TensorInt64Bit>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).Create2)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(TensorInt64Bit::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn create_from_array(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &[i64]) -> Result<Option<TensorInt64Bit>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).CreateFromArray)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, data.len() as u32, data.as_ptr() as *mut _, &mut out);
        if hr == S_OK { Ok(TensorInt64Bit::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn create_from_iterable(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &ComPtr<foundation::collections::IIterable<i64>>) -> Result<Option<TensorInt64Bit>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).CreateFromIterable)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, data.as_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(TensorInt64Bit::wrap(out)) } else { err(hr) }
    }}
...
impl TensorInt8Bit {
    ...
    #[inline] pub fn create2(shape: &ComPtr<foundation::collections::IIterable<i64>>) -> Result<Option<TensorInt8Bit>> {
        <Self as RtActivatable<ITensorInt8BitStatics>>::get_activation_factory().create2(shape)
    }
    #[inline] pub fn create_from_array(shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &[u8]) -> Result<Option<TensorInt8Bit>> {
        <Self as RtActivatable<ITensorInt8BitStatics>>::get_activation_factory().create_from_array(shape, data)
    }
    #[inline] pub fn create_from_iterable(shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &ComPtr<foundation::collections::IIterable<u8>>) -> Result<Option<TensorInt8Bit>> {
...
RT_INTERFACE!{static interface ITensorInt8BitStatics(ITensorInt8BitStaticsVtbl): IInspectable(IInspectableVtbl) [IID_ITensorInt8BitStatics] {
    ...
    fn Create2(&self, shape: *mut foundation::collections::IIterable<i64>, out: *mut <TensorInt8Bit as RtType>::Abi) -> HRESULT,
    fn CreateFromArray(&self, shape: *mut foundation::collections::IIterable<i64>, dataSize: u32, data: *mut u8, out: *mut <TensorInt8Bit as RtType>::Abi) -> HRESULT,
    fn CreateFromIterable(&self, shape: *mut foundation::collections::IIterable<i64>, data: *mut foundation::collections::IIterable<u8>, out: *mut <TensorInt8Bit as RtType>::Abi) -> HRESULT
}}
impl ComPtr<ITensorInt8BitStatics> {
    ...
    #[inline] pub fn create2(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>) -> Result<Option<TensorInt8Bit>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).Create2)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(TensorInt8Bit::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn create_from_array(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &[u8]) -> Result<Option<TensorInt8Bit>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).CreateFromArray)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, data.len() as u32, data.as_ptr() as *mut _, &mut out);
        if hr == S_OK { Ok(TensorInt8Bit::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn create_from_iterable(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &ComPtr<foundation::collections::IIterable<u8>>) -> Result<Option<TensorInt8Bit>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).CreateFromIterable)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, data.as_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(TensorInt8Bit::wrap(out)) } else { err(hr) }
    }}
...
impl TensorString {
    ...
    #[inline] pub fn create2(shape: &ComPtr<foundation::collections::IIterable<i64>>) -> Result<Option<TensorString>> {
        <Self as RtActivatable<ITensorStringStatics>>::get_activation_factory().create2(shape)
    }
    #[inline] pub fn create_from_array(shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &[&HStringArg]) -> Result<Option<TensorString>> {
        <Self as RtActivatable<ITensorStringStatics>>::get_activation_factory().create_from_array(shape, data)
    }
    #[inline] pub fn create_from_iterable(shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &ComPtr<foundation::collections::IIterable<HString>>) -> Result<Option<TensorString>> {
...
RT_INTERFACE!{static interface ITensorStringStatics(ITensorStringStaticsVtbl): IInspectable(IInspectableVtbl) [IID_ITensorStringStatics] {
    ...
    fn Create2(&self, shape: *mut foundation::collections::IIterable<i64>, out: *mut <TensorString as RtType>::Abi) -> HRESULT,
    fn CreateFromArray(&self, shape: *mut foundation::collections::IIterable<i64>, dataSize: u32, data: *mut HSTRING, out: *mut <TensorString as RtType>::Abi) -> HRESULT,
    fn CreateFromIterable(&self, shape: *mut foundation::collections::IIterable<i64>, data: *mut foundation::collections::IIterable<HString>, out: *mut <TensorString as RtType>::Abi) -> HRESULT
}}
impl ComPtr<ITensorStringStatics> {
    ...
    #[inline] pub fn create2(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>) -> Result<Option<TensorString>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).Create2)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(TensorString::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn create_from_array(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &[&HStringArg]) -> Result<Option<TensorString>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).CreateFromArray)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, data.len() as u32, data.as_ptr() as *mut _, &mut out);
        if hr == S_OK { Ok(TensorString::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn create_from_iterable(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &ComPtr<foundation::collections::IIterable<HString>>) -> Result<Option<TensorString>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).CreateFromIterable)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, data.as_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(TensorString::wrap(out)) } else { err(hr) }
    }}
...
impl TensorUInt16Bit {
    ...
    #[inline] pub fn create2(shape: &ComPtr<foundation::collections::IIterable<i64>>) -> Result<Option<TensorUInt16Bit>> {
        <Self as RtActivatable<ITensorUInt16BitStatics>>::get_activation_factory().create2(shape)
    }
    #[inline] pub fn create_from_array(shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &[u16]) -> Result<Option<TensorUInt16Bit>> {
        <Self as RtActivatable<ITensorUInt16BitStatics>>::get_activation_factory().create_from_array(shape, data)
    }
    #[inline] pub fn create_from_iterable(shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &ComPtr<foundation::collections::IIterable<u16>>) -> Result<Option<TensorUInt16Bit>> {
...
RT_INTERFACE!{static interface ITensorUInt16BitStatics(ITensorUInt16BitStaticsVtbl): IInspectable(IInspectableVtbl) [IID_ITensorUInt16BitStatics] {
    ...
    fn Create2(&self, shape: *mut foundation::collections::IIterable<i64>, out: *mut <TensorUInt16Bit as RtType>::Abi) -> HRESULT,
    fn CreateFromArray(&self, shape: *mut foundation::collections::IIterable<i64>, dataSize: u32, data: *mut u16, out: *mut <TensorUInt16Bit as RtType>::Abi) -> HRESULT,
    fn CreateFromIterable(&self, shape: *mut foundation::collections::IIterable<i64>, data: *mut foundation::collections::IIterable<u16>, out: *mut <TensorUInt16Bit as RtType>::Abi) -> HRESULT
}}
impl ComPtr<ITensorUInt16BitStatics> {
    ...
    #[inline] pub fn create2(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>) -> Result<Option<TensorUInt16Bit>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).Create2)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(TensorUInt16Bit::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn create_from_array(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &[u16]) -> Result<Option<TensorUInt16Bit>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).CreateFromArray)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, data.len() as u32, data.as_ptr() as *mut _, &mut out);
        if hr == S_OK { Ok(TensorUInt16Bit::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn create_from_iterable(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &ComPtr<foundation::collections::IIterable<u16>>) -> Result<Option<TensorUInt16Bit>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).CreateFromIterable)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, data.as_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(TensorUInt16Bit::wrap(out)) } else { err(hr) }
    }}
...
impl TensorUInt32Bit {
    ...
    #[inline] pub fn create2(shape: &ComPtr<foundation::collections::IIterable<i64>>) -> Result<Option<TensorUInt32Bit>> {
        <Self as RtActivatable<ITensorUInt32BitStatics>>::get_activation_factory().create2(shape)
    }
    #[inline] pub fn create_from_array(shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &[u32]) -> Result<Option<TensorUInt32Bit>> {
        <Self as RtActivatable<ITensorUInt32BitStatics>>::get_activation_factory().create_from_array(shape, data)
    }
    #[inline] pub fn create_from_iterable(shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &ComPtr<foundation::collections::IIterable<u32>>) -> Result<Option<TensorUInt32Bit>> {
...
RT_INTERFACE!{static interface ITensorUInt32BitStatics(ITensorUInt32BitStaticsVtbl): IInspectable(IInspectableVtbl) [IID_ITensorUInt32BitStatics] {
    ...
    fn Create2(&self, shape: *mut foundation::collections::IIterable<i64>, out: *mut <TensorUInt32Bit as RtType>::Abi) -> HRESULT,
    fn CreateFromArray(&self, shape: *mut foundation::collections::IIterable<i64>, dataSize: u32, data: *mut u32, out: *mut <TensorUInt32Bit as RtType>::Abi) -> HRESULT,
    fn CreateFromIterable(&self, shape: *mut foundation::collections::IIterable<i64>, data: *mut foundation::collections::IIterable<u32>, out: *mut <TensorUInt32Bit as RtType>::Abi) -> HRESULT
}}
impl ComPtr<ITensorUInt32BitStatics> {
    ...
    #[inline] pub fn create2(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>) -> Result<Option<TensorUInt32Bit>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).Create2)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(TensorUInt32Bit::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn create_from_array(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &[u32]) -> Result<Option<TensorUInt32Bit>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).CreateFromArray)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, data.len() as u32, data.as_ptr() as *mut _, &mut out);
        if hr == S_OK { Ok(TensorUInt32Bit::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn create_from_iterable(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &ComPtr<foundation::collections::IIterable<u32>>) -> Result<Option<TensorUInt32Bit>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).CreateFromIterable)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, data.as_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(TensorUInt32Bit::wrap(out)) } else { err(hr) }
    }}
...
impl TensorUInt64Bit {
    ...
    #[inline] pub fn create2(shape: &ComPtr<foundation::collections::IIterable<i64>>) -> Result<Option<TensorUInt64Bit>> {
        <Self as RtActivatable<ITensorUInt64BitStatics>>::get_activation_factory().create2(shape)
    }
    #[inline] pub fn create_from_array(shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &[u64]) -> Result<Option<TensorUInt64Bit>> {
        <Self as RtActivatable<ITensorUInt64BitStatics>>::get_activation_factory().create_from_array(shape, data)
    }
    #[inline] pub fn create_from_iterable(shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &ComPtr<foundation::collections::IIterable<u64>>) -> Result<Option<TensorUInt64Bit>> {
...
RT_INTERFACE!{static interface ITensorUInt64BitStatics(ITensorUInt64BitStaticsVtbl): IInspectable(IInspectableVtbl) [IID_ITensorUInt64BitStatics] {
    ...
    fn Create2(&self, shape: *mut foundation::collections::IIterable<i64>, out: *mut <TensorUInt64Bit as RtType>::Abi) -> HRESULT,
    fn CreateFromArray(&self, shape: *mut foundation::collections::IIterable<i64>, dataSize: u32, data: *mut u64, out: *mut <TensorUInt64Bit as RtType>::Abi) -> HRESULT,
    fn CreateFromIterable(&self, shape: *mut foundation::collections::IIterable<i64>, data: *mut foundation::collections::IIterable<u64>, out: *mut <TensorUInt64Bit as RtType>::Abi) -> HRESULT
}}
impl ComPtr<ITensorUInt64BitStatics> {
    ...
    #[inline] pub fn create2(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>) -> Result<Option<TensorUInt64Bit>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).Create2)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(TensorUInt64Bit::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn create_from_array(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &[u64]) -> Result<Option<TensorUInt64Bit>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).CreateFromArray)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, data.len() as u32, data.as_ptr() as *mut _, &mut out);
        if hr == S_OK { Ok(TensorUInt64Bit::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn create_from_iterable(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &ComPtr<foundation::collections::IIterable<u64>>) -> Result<Option<TensorUInt64Bit>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).CreateFromIterable)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, data.as_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(TensorUInt64Bit::wrap(out)) } else { err(hr) }
    }}
...
impl TensorUInt8Bit {
    ...
    #[inline] pub fn create2(shape: &ComPtr<foundation::collections::IIterable<i64>>) -> Result<Option<TensorUInt8Bit>> {
        <Self as RtActivatable<ITensorUInt8BitStatics>>::get_activation_factory().create2(shape)
    }
    #[inline] pub fn create_from_array(shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &[u8]) -> Result<Option<TensorUInt8Bit>> {
        <Self as RtActivatable<ITensorUInt8BitStatics>>::get_activation_factory().create_from_array(shape, data)
    }
    #[inline] pub fn create_from_iterable(shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &ComPtr<foundation::collections::IIterable<u8>>) -> Result<Option<TensorUInt8Bit>> {
...
RT_INTERFACE!{static interface ITensorUInt8BitStatics(ITensorUInt8BitStaticsVtbl): IInspectable(IInspectableVtbl) [IID_ITensorUInt8BitStatics] {
    ...
    fn Create2(&self, shape: *mut foundation::collections::IIterable<i64>, out: *mut <TensorUInt8Bit as RtType>::Abi) -> HRESULT,
    fn CreateFromArray(&self, shape: *mut foundation::collections::IIterable<i64>, dataSize: u32, data: *mut u8, out: *mut <TensorUInt8Bit as RtType>::Abi) -> HRESULT,
    fn CreateFromIterable(&self, shape: *mut foundation::collections::IIterable<i64>, data: *mut foundation::collections::IIterable<u8>, out: *mut <TensorUInt8Bit as RtType>::Abi) -> HRESULT
}}
impl ComPtr<ITensorUInt8BitStatics> {
    ...
    #[inline] pub fn create2(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>) -> Result<Option<TensorUInt8Bit>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).Create2)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(TensorUInt8Bit::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn create_from_array(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &[u8]) -> Result<Option<TensorUInt8Bit>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).CreateFromArray)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, data.len() as u32, data.as_ptr() as *mut _, &mut out);
        if hr == S_OK { Ok(TensorUInt8Bit::wrap(out)) } else { err(hr) }
    }}
    #[inline] pub fn create_from_iterable(&self, shape: &ComPtr<foundation::collections::IIterable<i64>>, data: &ComPtr<foundation::collections::IIterable<u8>>) -> Result<Option<TensorUInt8Bit>> { unsafe { 
        let mut out = null_mut();
        let hr = ((*self.as_abi().lpVtbl).CreateFromIterable)(self.as_abi() as *const _ as *mut _, shape.as_abi() as *const _ as *mut _, data.as_abi() as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(TensorUInt8Bit::wrap(out)) } else { err(hr) }
    }}
...
RT_INTERFACE!{interface ILearningModelPreview(ILearningModelPreviewVtbl): IInspectable(IInspectableVtbl) [IID_ILearningModelPreview] {
    fn EvaluateAsync(&self, binding: <LearningModelBindingPreview as RtType>::Abi, correlationId: HSTRING, out: *mut *mut foundation::IAsyncOperation<LearningModelEvaluationResultPreview>) -> HRESULT,
