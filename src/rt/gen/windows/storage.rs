...
impl IApplicationData {
    ...
    #[inline] pub unsafe fn set_version_async(&self, desiredVersion: u32, handler: &ApplicationDataSetVersionHandler) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).SetVersionAsync)(self as *const _ as *mut _, desiredVersion, handler as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn clear_all_async(&self) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).ClearAllAsync)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn clear_async(&self, locality: ApplicationDataLocality) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn add_data_changed(&self, handler: &foundation::TypedEventHandler<ApplicationData, IInspectable>) -> Result<foundation::EventRegistrationToken> {
        let mut out = zeroed();
        let hr = ((*self.lpVtbl).add_DataChanged)(self as *const _ as *mut _, handler as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }
    #[inline] pub unsafe fn remove_data_changed(&self, token: foundation::EventRegistrationToken) -> Result<()> {
...
impl ApplicationData {
    ...
    #[cfg(feature="windows-system")] #[inline] pub fn get_for_user_async(user: &super::system::User) -> Result<ComPtr<foundation::IAsyncOperation<ApplicationData>>> { unsafe {
...
impl IApplicationData3 {
    ...
    #[inline] pub unsafe fn clear_publisher_cache_folder_async(&self, folderName: &HStringArg) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
...
impl IApplicationDataContainer {
    ...
    #[inline] pub unsafe fn get_values(&self) -> Result<Option<ComPtr<foundation::collections::IPropertySet>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).get_Values)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap_optional(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_containers(&self) -> Result<Option<ComPtr<foundation::collections::IMapView<HString, ApplicationDataContainer>>>> {
        let mut out = null_mut();
...
impl IApplicationDataStatics2 {
    #[cfg(feature="windows-system")] #[inline] pub unsafe fn get_for_user_async(&self, user: &super::system::User) -> Result<ComPtr<foundation::IAsyncOperation<ApplicationData>>> {
        let mut out = null_mut();
...
impl CachedFileManager {
    ...
    #[inline] pub fn complete_updates_async(file: &IStorageFile) -> Result<ComPtr<foundation::IAsyncOperation<provider::FileUpdateStatus>>> { unsafe {
...
impl ICachedFileManagerStatics {
    ...
    #[inline] pub unsafe fn complete_updates_async(&self, file: &IStorageFile) -> Result<ComPtr<foundation::IAsyncOperation<provider::FileUpdateStatus>>> {
        let mut out = null_mut();
...
impl DownloadsFolder {
    #[inline] pub fn create_file_async(desiredName: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<StorageFile>>> { unsafe {
        <Self as RtActivatable<IDownloadsFolderStatics>>::get_activation_factory().create_file_async(desiredName)
    }}
    #[inline] pub fn create_folder_async(desiredName: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<StorageFolder>>> { unsafe {
        <Self as RtActivatable<IDownloadsFolderStatics>>::get_activation_factory().create_folder_async(desiredName)
    }}
    #[inline] pub fn create_file_with_collision_option_async(desiredName: &HStringArg, option: CreationCollisionOption) -> Result<ComPtr<foundation::IAsyncOperation<StorageFile>>> { unsafe {
    ...
    #[inline] pub fn create_folder_with_collision_option_async(desiredName: &HStringArg, option: CreationCollisionOption) -> Result<ComPtr<foundation::IAsyncOperation<StorageFolder>>> { unsafe {
    ...
    #[cfg(feature="windows-system")] #[inline] pub fn create_file_for_user_async(user: &super::system::User, desiredName: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<StorageFile>>> { unsafe {
        <Self as RtActivatable<IDownloadsFolderStatics2>>::get_activation_factory().create_file_for_user_async(user, desiredName)
    }}
    #[cfg(feature="windows-system")] #[inline] pub fn create_folder_for_user_async(user: &super::system::User, desiredName: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<StorageFolder>>> { unsafe {
        <Self as RtActivatable<IDownloadsFolderStatics2>>::get_activation_factory().create_folder_for_user_async(user, desiredName)
    }}
    #[cfg(feature="windows-system")] #[inline] pub fn create_file_for_user_with_collision_option_async(user: &super::system::User, desiredName: &HStringArg, option: CreationCollisionOption) -> Result<ComPtr<foundation::IAsyncOperation<StorageFile>>> { unsafe {
    ...
    #[cfg(feature="windows-system")] #[inline] pub fn create_folder_for_user_with_collision_option_async(user: &super::system::User, desiredName: &HStringArg, option: CreationCollisionOption) -> Result<ComPtr<foundation::IAsyncOperation<StorageFolder>>> { unsafe {
...
impl IDownloadsFolderStatics {
    #[inline] pub unsafe fn create_file_async(&self, desiredName: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<StorageFile>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).CreateFileAsync)(self as *const _ as *mut _, desiredName.get(), &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn create_folder_async(&self, desiredName: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<StorageFolder>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).CreateFolderAsync)(self as *const _ as *mut _, desiredName.get(), &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn create_file_with_collision_option_async(&self, desiredName: &HStringArg, option: CreationCollisionOption) -> Result<ComPtr<foundation::IAsyncOperation<StorageFile>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).CreateFileWithCollisionOptionAsync)(self as *const _ as *mut _, desiredName.get(), option, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn create_folder_with_collision_option_async(&self, desiredName: &HStringArg, option: CreationCollisionOption) -> Result<ComPtr<foundation::IAsyncOperation<StorageFolder>>> {
        let mut out = null_mut();
...
impl IDownloadsFolderStatics2 {
    #[cfg(feature="windows-system")] #[inline] pub unsafe fn create_file_for_user_async(&self, user: &super::system::User, desiredName: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<StorageFile>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).CreateFileForUserAsync)(self as *const _ as *mut _, user as *const _ as *mut _, desiredName.get(), &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[cfg(feature="windows-system")] #[inline] pub unsafe fn create_folder_for_user_async(&self, user: &super::system::User, desiredName: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<StorageFolder>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).CreateFolderForUserAsync)(self as *const _ as *mut _, user as *const _ as *mut _, desiredName.get(), &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[cfg(feature="windows-system")] #[inline] pub unsafe fn create_file_for_user_with_collision_option_async(&self, user: &super::system::User, desiredName: &HStringArg, option: CreationCollisionOption) -> Result<ComPtr<foundation::IAsyncOperation<StorageFile>>> {
        let mut out = null_mut();
    ...
    #[cfg(feature="windows-system")] #[inline] pub unsafe fn create_folder_for_user_with_collision_option_async(&self, user: &super::system::User, desiredName: &HStringArg, option: CreationCollisionOption) -> Result<ComPtr<foundation::IAsyncOperation<StorageFolder>>> {
        let mut out = null_mut();
...
impl FileIO {
    #[inline] pub fn read_text_async(file: &IStorageFile) -> Result<ComPtr<foundation::IAsyncOperation<HString>>> { unsafe {
        <Self as RtActivatable<IFileIOStatics>>::get_activation_factory().read_text_async(file)
    }}
    #[inline] pub fn read_text_with_encoding_async(file: &IStorageFile, encoding: streams::UnicodeEncoding) -> Result<ComPtr<foundation::IAsyncOperation<HString>>> { unsafe {
        <Self as RtActivatable<IFileIOStatics>>::get_activation_factory().read_text_with_encoding_async(file, encoding)
    }}
    #[inline] pub fn write_text_async(file: &IStorageFile, contents: &HStringArg) -> Result<ComPtr<foundation::IAsyncAction>> { unsafe {
        <Self as RtActivatable<IFileIOStatics>>::get_activation_factory().write_text_async(file, contents)
    }}
    #[inline] pub fn write_text_with_encoding_async(file: &IStorageFile, contents: &HStringArg, encoding: streams::UnicodeEncoding) -> Result<ComPtr<foundation::IAsyncAction>> { unsafe {
        <Self as RtActivatable<IFileIOStatics>>::get_activation_factory().write_text_with_encoding_async(file, contents, encoding)
    }}
    #[inline] pub fn append_text_async(file: &IStorageFile, contents: &HStringArg) -> Result<ComPtr<foundation::IAsyncAction>> { unsafe {
        <Self as RtActivatable<IFileIOStatics>>::get_activation_factory().append_text_async(file, contents)
    }}
    #[inline] pub fn append_text_with_encoding_async(file: &IStorageFile, contents: &HStringArg, encoding: streams::UnicodeEncoding) -> Result<ComPtr<foundation::IAsyncAction>> { unsafe {
        <Self as RtActivatable<IFileIOStatics>>::get_activation_factory().append_text_with_encoding_async(file, contents, encoding)
    }}
    #[inline] pub fn read_lines_async(file: &IStorageFile) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVector<HString>>>> { unsafe {
        <Self as RtActivatable<IFileIOStatics>>::get_activation_factory().read_lines_async(file)
    }}
    #[inline] pub fn read_lines_with_encoding_async(file: &IStorageFile, encoding: streams::UnicodeEncoding) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVector<HString>>>> { unsafe {
        <Self as RtActivatable<IFileIOStatics>>::get_activation_factory().read_lines_with_encoding_async(file, encoding)
    }}
    #[inline] pub fn write_lines_async(file: &IStorageFile, lines: &foundation::collections::IIterable<HString>) -> Result<ComPtr<foundation::IAsyncAction>> { unsafe {
        <Self as RtActivatable<IFileIOStatics>>::get_activation_factory().write_lines_async(file, lines)
    }}
    #[inline] pub fn write_lines_with_encoding_async(file: &IStorageFile, lines: &foundation::collections::IIterable<HString>, encoding: streams::UnicodeEncoding) -> Result<ComPtr<foundation::IAsyncAction>> { unsafe {
        <Self as RtActivatable<IFileIOStatics>>::get_activation_factory().write_lines_with_encoding_async(file, lines, encoding)
    }}
    #[inline] pub fn append_lines_async(file: &IStorageFile, lines: &foundation::collections::IIterable<HString>) -> Result<ComPtr<foundation::IAsyncAction>> { unsafe {
        <Self as RtActivatable<IFileIOStatics>>::get_activation_factory().append_lines_async(file, lines)
    }}
    #[inline] pub fn append_lines_with_encoding_async(file: &IStorageFile, lines: &foundation::collections::IIterable<HString>, encoding: streams::UnicodeEncoding) -> Result<ComPtr<foundation::IAsyncAction>> { unsafe {
        <Self as RtActivatable<IFileIOStatics>>::get_activation_factory().append_lines_with_encoding_async(file, lines, encoding)
    }}
    #[inline] pub fn read_buffer_async(file: &IStorageFile) -> Result<ComPtr<foundation::IAsyncOperation<streams::IBuffer>>> { unsafe {
        <Self as RtActivatable<IFileIOStatics>>::get_activation_factory().read_buffer_async(file)
    }}
    #[inline] pub fn write_buffer_async(file: &IStorageFile, buffer: &streams::IBuffer) -> Result<ComPtr<foundation::IAsyncAction>> { unsafe {
        <Self as RtActivatable<IFileIOStatics>>::get_activation_factory().write_buffer_async(file, buffer)
    }}
    #[inline] pub fn write_bytes_async(file: &IStorageFile, buffer: &[u8]) -> Result<ComPtr<foundation::IAsyncAction>> { unsafe {
...
impl IFileIOStatics {
    #[inline] pub unsafe fn read_text_async(&self, file: &IStorageFile) -> Result<ComPtr<foundation::IAsyncOperation<HString>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).ReadTextAsync)(self as *const _ as *mut _, file as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn read_text_with_encoding_async(&self, file: &IStorageFile, encoding: streams::UnicodeEncoding) -> Result<ComPtr<foundation::IAsyncOperation<HString>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).ReadTextWithEncodingAsync)(self as *const _ as *mut _, file as *const _ as *mut _, encoding, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn write_text_async(&self, file: &IStorageFile, contents: &HStringArg) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).WriteTextAsync)(self as *const _ as *mut _, file as *const _ as *mut _, contents.get(), &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn write_text_with_encoding_async(&self, file: &IStorageFile, contents: &HStringArg, encoding: streams::UnicodeEncoding) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn append_text_async(&self, file: &IStorageFile, contents: &HStringArg) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).AppendTextAsync)(self as *const _ as *mut _, file as *const _ as *mut _, contents.get(), &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn append_text_with_encoding_async(&self, file: &IStorageFile, contents: &HStringArg, encoding: streams::UnicodeEncoding) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn read_lines_async(&self, file: &IStorageFile) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVector<HString>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).ReadLinesAsync)(self as *const _ as *mut _, file as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn read_lines_with_encoding_async(&self, file: &IStorageFile, encoding: streams::UnicodeEncoding) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVector<HString>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).ReadLinesWithEncodingAsync)(self as *const _ as *mut _, file as *const _ as *mut _, encoding, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn write_lines_async(&self, file: &IStorageFile, lines: &foundation::collections::IIterable<HString>) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).WriteLinesAsync)(self as *const _ as *mut _, file as *const _ as *mut _, lines as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn write_lines_with_encoding_async(&self, file: &IStorageFile, lines: &foundation::collections::IIterable<HString>, encoding: streams::UnicodeEncoding) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn append_lines_async(&self, file: &IStorageFile, lines: &foundation::collections::IIterable<HString>) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).AppendLinesAsync)(self as *const _ as *mut _, file as *const _ as *mut _, lines as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn append_lines_with_encoding_async(&self, file: &IStorageFile, lines: &foundation::collections::IIterable<HString>, encoding: streams::UnicodeEncoding) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn read_buffer_async(&self, file: &IStorageFile) -> Result<ComPtr<foundation::IAsyncOperation<streams::IBuffer>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).ReadBufferAsync)(self as *const _ as *mut _, file as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn write_buffer_async(&self, file: &IStorageFile, buffer: &streams::IBuffer) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).WriteBufferAsync)(self as *const _ as *mut _, file as *const _ as *mut _, buffer as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn write_bytes_async(&self, file: &IStorageFile, buffer: &[u8]) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
...
impl KnownFolders {
    ...
    #[cfg(feature="windows-system")] #[inline] pub fn get_folder_for_user_async(user: &super::system::User, folderId: KnownFolderId) -> Result<ComPtr<foundation::IAsyncOperation<StorageFolder>>> { unsafe {
...
impl IKnownFoldersStatics3 {
    #[cfg(feature="windows-system")] #[inline] pub unsafe fn get_folder_for_user_async(&self, user: &super::system::User, folderId: KnownFolderId) -> Result<ComPtr<foundation::IAsyncOperation<StorageFolder>>> {
        let mut out = null_mut();
...
impl PathIO {
    #[inline] pub fn read_text_async(absolutePath: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<HString>>> { unsafe {
        <Self as RtActivatable<IPathIOStatics>>::get_activation_factory().read_text_async(absolutePath)
    }}
    #[inline] pub fn read_text_with_encoding_async(absolutePath: &HStringArg, encoding: streams::UnicodeEncoding) -> Result<ComPtr<foundation::IAsyncOperation<HString>>> { unsafe {
        <Self as RtActivatable<IPathIOStatics>>::get_activation_factory().read_text_with_encoding_async(absolutePath, encoding)
    }}
    #[inline] pub fn write_text_async(absolutePath: &HStringArg, contents: &HStringArg) -> Result<ComPtr<foundation::IAsyncAction>> { unsafe {
        <Self as RtActivatable<IPathIOStatics>>::get_activation_factory().write_text_async(absolutePath, contents)
    }}
    #[inline] pub fn write_text_with_encoding_async(absolutePath: &HStringArg, contents: &HStringArg, encoding: streams::UnicodeEncoding) -> Result<ComPtr<foundation::IAsyncAction>> { unsafe {
    ...
    #[inline] pub fn append_text_async(absolutePath: &HStringArg, contents: &HStringArg) -> Result<ComPtr<foundation::IAsyncAction>> { unsafe {
        <Self as RtActivatable<IPathIOStatics>>::get_activation_factory().append_text_async(absolutePath, contents)
    }}
    #[inline] pub fn append_text_with_encoding_async(absolutePath: &HStringArg, contents: &HStringArg, encoding: streams::UnicodeEncoding) -> Result<ComPtr<foundation::IAsyncAction>> { unsafe {
    ...
    #[inline] pub fn read_lines_async(absolutePath: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVector<HString>>>> { unsafe {
        <Self as RtActivatable<IPathIOStatics>>::get_activation_factory().read_lines_async(absolutePath)
    }}
    #[inline] pub fn read_lines_with_encoding_async(absolutePath: &HStringArg, encoding: streams::UnicodeEncoding) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVector<HString>>>> { unsafe {
        <Self as RtActivatable<IPathIOStatics>>::get_activation_factory().read_lines_with_encoding_async(absolutePath, encoding)
    }}
    #[inline] pub fn write_lines_async(absolutePath: &HStringArg, lines: &foundation::collections::IIterable<HString>) -> Result<ComPtr<foundation::IAsyncAction>> { unsafe {
        <Self as RtActivatable<IPathIOStatics>>::get_activation_factory().write_lines_async(absolutePath, lines)
    }}
    #[inline] pub fn write_lines_with_encoding_async(absolutePath: &HStringArg, lines: &foundation::collections::IIterable<HString>, encoding: streams::UnicodeEncoding) -> Result<ComPtr<foundation::IAsyncAction>> { unsafe {
        <Self as RtActivatable<IPathIOStatics>>::get_activation_factory().write_lines_with_encoding_async(absolutePath, lines, encoding)
    }}
    #[inline] pub fn append_lines_async(absolutePath: &HStringArg, lines: &foundation::collections::IIterable<HString>) -> Result<ComPtr<foundation::IAsyncAction>> { unsafe {
        <Self as RtActivatable<IPathIOStatics>>::get_activation_factory().append_lines_async(absolutePath, lines)
    }}
    #[inline] pub fn append_lines_with_encoding_async(absolutePath: &HStringArg, lines: &foundation::collections::IIterable<HString>, encoding: streams::UnicodeEncoding) -> Result<ComPtr<foundation::IAsyncAction>> { unsafe {
        <Self as RtActivatable<IPathIOStatics>>::get_activation_factory().append_lines_with_encoding_async(absolutePath, lines, encoding)
    }}
    #[inline] pub fn read_buffer_async(absolutePath: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<streams::IBuffer>>> { unsafe {
        <Self as RtActivatable<IPathIOStatics>>::get_activation_factory().read_buffer_async(absolutePath)
    }}
    #[inline] pub fn write_buffer_async(absolutePath: &HStringArg, buffer: &streams::IBuffer) -> Result<ComPtr<foundation::IAsyncAction>> { unsafe {
        <Self as RtActivatable<IPathIOStatics>>::get_activation_factory().write_buffer_async(absolutePath, buffer)
    }}
    #[inline] pub fn write_bytes_async(absolutePath: &HStringArg, buffer: &[u8]) -> Result<ComPtr<foundation::IAsyncAction>> { unsafe {
...
impl IPathIOStatics {
    #[inline] pub unsafe fn read_text_async(&self, absolutePath: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<HString>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).ReadTextAsync)(self as *const _ as *mut _, absolutePath.get(), &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn read_text_with_encoding_async(&self, absolutePath: &HStringArg, encoding: streams::UnicodeEncoding) -> Result<ComPtr<foundation::IAsyncOperation<HString>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).ReadTextWithEncodingAsync)(self as *const _ as *mut _, absolutePath.get(), encoding, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn write_text_async(&self, absolutePath: &HStringArg, contents: &HStringArg) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).WriteTextAsync)(self as *const _ as *mut _, absolutePath.get(), contents.get(), &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn write_text_with_encoding_async(&self, absolutePath: &HStringArg, contents: &HStringArg, encoding: streams::UnicodeEncoding) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).WriteTextWithEncodingAsync)(self as *const _ as *mut _, absolutePath.get(), contents.get(), encoding, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn append_text_async(&self, absolutePath: &HStringArg, contents: &HStringArg) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).AppendTextAsync)(self as *const _ as *mut _, absolutePath.get(), contents.get(), &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn append_text_with_encoding_async(&self, absolutePath: &HStringArg, contents: &HStringArg, encoding: streams::UnicodeEncoding) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).AppendTextWithEncodingAsync)(self as *const _ as *mut _, absolutePath.get(), contents.get(), encoding, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn read_lines_async(&self, absolutePath: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVector<HString>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).ReadLinesAsync)(self as *const _ as *mut _, absolutePath.get(), &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn read_lines_with_encoding_async(&self, absolutePath: &HStringArg, encoding: streams::UnicodeEncoding) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVector<HString>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).ReadLinesWithEncodingAsync)(self as *const _ as *mut _, absolutePath.get(), encoding, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn write_lines_async(&self, absolutePath: &HStringArg, lines: &foundation::collections::IIterable<HString>) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).WriteLinesAsync)(self as *const _ as *mut _, absolutePath.get(), lines as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn write_lines_with_encoding_async(&self, absolutePath: &HStringArg, lines: &foundation::collections::IIterable<HString>, encoding: streams::UnicodeEncoding) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn append_lines_async(&self, absolutePath: &HStringArg, lines: &foundation::collections::IIterable<HString>) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).AppendLinesAsync)(self as *const _ as *mut _, absolutePath.get(), lines as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn append_lines_with_encoding_async(&self, absolutePath: &HStringArg, lines: &foundation::collections::IIterable<HString>, encoding: streams::UnicodeEncoding) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn read_buffer_async(&self, absolutePath: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<streams::IBuffer>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).ReadBufferAsync)(self as *const _ as *mut _, absolutePath.get(), &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn write_buffer_async(&self, absolutePath: &HStringArg, buffer: &streams::IBuffer) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).WriteBufferAsync)(self as *const _ as *mut _, absolutePath.get(), buffer as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn write_bytes_async(&self, absolutePath: &HStringArg, buffer: &[u8]) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
...
impl IStorageFile {
    ...
    #[inline] pub unsafe fn open_async(&self, accessMode: FileAccessMode) -> Result<ComPtr<foundation::IAsyncOperation<streams::IRandomAccessStream>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).OpenAsync)(self as *const _ as *mut _, accessMode, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn open_transacted_write_async(&self) -> Result<ComPtr<foundation::IAsyncOperation<StorageStreamTransaction>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).OpenTransactedWriteAsync)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn copy_overload_default_name_and_options(&self, destinationFolder: &IStorageFolder) -> Result<ComPtr<foundation::IAsyncOperation<StorageFile>>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn copy_overload_default_options(&self, destinationFolder: &IStorageFolder, desiredNewName: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<StorageFile>>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn copy_overload(&self, destinationFolder: &IStorageFolder, desiredNewName: &HStringArg, option: NameCollisionOption) -> Result<ComPtr<foundation::IAsyncOperation<StorageFile>>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn copy_and_replace_async(&self, fileToReplace: &IStorageFile) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).CopyAndReplaceAsync)(self as *const _ as *mut _, fileToReplace as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn move_overload_default_name_and_options(&self, destinationFolder: &IStorageFolder) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn move_overload_default_options(&self, destinationFolder: &IStorageFolder, desiredNewName: &HStringArg) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn move_overload(&self, destinationFolder: &IStorageFolder, desiredNewName: &HStringArg, option: NameCollisionOption) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn move_and_replace_async(&self, fileToReplace: &IStorageFile) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
...
impl StorageFile {
    #[inline] pub fn get_file_from_path_async(path: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<StorageFile>>> { unsafe {
        <Self as RtActivatable<IStorageFileStatics>>::get_activation_factory().get_file_from_path_async(path)
    }}
    #[inline] pub fn get_file_from_application_uri_async(uri: &foundation::Uri) -> Result<ComPtr<foundation::IAsyncOperation<StorageFile>>> { unsafe {
        <Self as RtActivatable<IStorageFileStatics>>::get_activation_factory().get_file_from_application_uri_async(uri)
    }}
    #[inline] pub fn create_streamed_file_async(displayNameWithExtension: &HStringArg, dataRequested: &StreamedFileDataRequestedHandler, thumbnail: &streams::IRandomAccessStreamReference) -> Result<ComPtr<foundation::IAsyncOperation<StorageFile>>> { unsafe {
    ...
    #[inline] pub fn replace_with_streamed_file_async(fileToReplace: &IStorageFile, dataRequested: &StreamedFileDataRequestedHandler, thumbnail: &streams::IRandomAccessStreamReference) -> Result<ComPtr<foundation::IAsyncOperation<StorageFile>>> { unsafe {
    ...
    #[inline] pub fn create_streamed_file_from_uri_async(displayNameWithExtension: &HStringArg, uri: &foundation::Uri, thumbnail: &streams::IRandomAccessStreamReference) -> Result<ComPtr<foundation::IAsyncOperation<StorageFile>>> { unsafe {
    ...
    #[inline] pub fn replace_with_streamed_file_from_uri_async(fileToReplace: &IStorageFile, uri: &foundation::Uri, thumbnail: &streams::IRandomAccessStreamReference) -> Result<ComPtr<foundation::IAsyncOperation<StorageFile>>> { unsafe {
...
impl IStorageFile2 {
    #[inline] pub unsafe fn open_with_options_async(&self, accessMode: FileAccessMode, options: StorageOpenOptions) -> Result<ComPtr<foundation::IAsyncOperation<streams::IRandomAccessStream>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).OpenWithOptionsAsync)(self as *const _ as *mut _, accessMode, options, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn open_transacted_write_with_options_async(&self, options: StorageOpenOptions) -> Result<ComPtr<foundation::IAsyncOperation<StorageStreamTransaction>>> {
        let mut out = null_mut();
...
impl IStorageFileStatics {
    #[inline] pub unsafe fn get_file_from_path_async(&self, path: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<StorageFile>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetFileFromPathAsync)(self as *const _ as *mut _, path.get(), &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_file_from_application_uri_async(&self, uri: &foundation::Uri) -> Result<ComPtr<foundation::IAsyncOperation<StorageFile>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetFileFromApplicationUriAsync)(self as *const _ as *mut _, uri as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn create_streamed_file_async(&self, displayNameWithExtension: &HStringArg, dataRequested: &StreamedFileDataRequestedHandler, thumbnail: &streams::IRandomAccessStreamReference) -> Result<ComPtr<foundation::IAsyncOperation<StorageFile>>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn replace_with_streamed_file_async(&self, fileToReplace: &IStorageFile, dataRequested: &StreamedFileDataRequestedHandler, thumbnail: &streams::IRandomAccessStreamReference) -> Result<ComPtr<foundation::IAsyncOperation<StorageFile>>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn create_streamed_file_from_uri_async(&self, displayNameWithExtension: &HStringArg, uri: &foundation::Uri, thumbnail: &streams::IRandomAccessStreamReference) -> Result<ComPtr<foundation::IAsyncOperation<StorageFile>>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn replace_with_streamed_file_from_uri_async(&self, fileToReplace: &IStorageFile, uri: &foundation::Uri, thumbnail: &streams::IRandomAccessStreamReference) -> Result<ComPtr<foundation::IAsyncOperation<StorageFile>>> {
        let mut out = null_mut();
...
impl IStorageFolder {
    #[inline] pub unsafe fn create_file_async_overload_default_options(&self, desiredName: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<StorageFile>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).CreateFileAsyncOverloadDefaultOptions)(self as *const _ as *mut _, desiredName.get(), &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn create_file_async(&self, desiredName: &HStringArg, options: CreationCollisionOption) -> Result<ComPtr<foundation::IAsyncOperation<StorageFile>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).CreateFileAsync)(self as *const _ as *mut _, desiredName.get(), options, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn create_folder_async_overload_default_options(&self, desiredName: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<StorageFolder>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).CreateFolderAsyncOverloadDefaultOptions)(self as *const _ as *mut _, desiredName.get(), &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn create_folder_async(&self, desiredName: &HStringArg, options: CreationCollisionOption) -> Result<ComPtr<foundation::IAsyncOperation<StorageFolder>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).CreateFolderAsync)(self as *const _ as *mut _, desiredName.get(), options, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_file_async(&self, name: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<StorageFile>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetFileAsync)(self as *const _ as *mut _, name.get(), &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_folder_async(&self, name: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<StorageFolder>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetFolderAsync)(self as *const _ as *mut _, name.get(), &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_item_async(&self, name: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<IStorageItem>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetItemAsync)(self as *const _ as *mut _, name.get(), &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_files_async_overload_default_options_start_and_count(&self) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVectorView<StorageFile>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetFilesAsyncOverloadDefaultOptionsStartAndCount)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_folders_async_overload_default_options_start_and_count(&self) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVectorView<StorageFolder>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetFoldersAsyncOverloadDefaultOptionsStartAndCount)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_items_async_overload_default_start_and_count(&self) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVectorView<IStorageItem>>>> {
        let mut out = null_mut();
...
impl StorageFolder {
    #[inline] pub fn get_folder_from_path_async(path: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<StorageFolder>>> { unsafe {
...
impl IStorageFolder2 {
    #[inline] pub unsafe fn try_get_item_async(&self, name: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<IStorageItem>>> {
        let mut out = null_mut();
...
impl IStorageFolderStatics {
    #[inline] pub unsafe fn get_folder_from_path_async(&self, path: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<StorageFolder>>> {
        let mut out = null_mut();
...
impl IStorageItem {
    #[inline] pub unsafe fn rename_async_overload_default_options(&self, desiredName: &HStringArg) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).RenameAsyncOverloadDefaultOptions)(self as *const _ as *mut _, desiredName.get(), &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn rename_async(&self, desiredName: &HStringArg, option: NameCollisionOption) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).RenameAsync)(self as *const _ as *mut _, desiredName.get(), option, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn delete_async_overload_default_options(&self) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).DeleteAsyncOverloadDefaultOptions)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn delete_async(&self, option: StorageDeleteOption) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).DeleteAsync)(self as *const _ as *mut _, option, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_basic_properties_async(&self) -> Result<ComPtr<foundation::IAsyncOperation<fileproperties::BasicProperties>>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn get_date_created(&self) -> Result<foundation::DateTime> {
        let mut out = zeroed();
...
impl IStorageItem2 {
    #[inline] pub unsafe fn get_parent_async(&self) -> Result<ComPtr<foundation::IAsyncOperation<StorageFolder>>> {
        let mut out = null_mut();
...
impl IStorageItemProperties {
    #[inline] pub unsafe fn get_thumbnail_async_overload_default_size_default_options(&self, mode: fileproperties::ThumbnailMode) -> Result<ComPtr<foundation::IAsyncOperation<fileproperties::StorageItemThumbnail>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetThumbnailAsyncOverloadDefaultSizeDefaultOptions)(self as *const _ as *mut _, mode, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_thumbnail_async_overload_default_options(&self, mode: fileproperties::ThumbnailMode, requestedSize: u32) -> Result<ComPtr<foundation::IAsyncOperation<fileproperties::StorageItemThumbnail>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetThumbnailAsyncOverloadDefaultOptions)(self as *const _ as *mut _, mode, requestedSize, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_thumbnail_async(&self, mode: fileproperties::ThumbnailMode, requestedSize: u32, options: fileproperties::ThumbnailOptions) -> Result<ComPtr<foundation::IAsyncOperation<fileproperties::StorageItemThumbnail>>> {
        let mut out = null_mut();
...
impl IStorageItemProperties2 {
    #[inline] pub unsafe fn get_scaled_image_as_thumbnail_async_overload_default_size_default_options(&self, mode: fileproperties::ThumbnailMode) -> Result<ComPtr<foundation::IAsyncOperation<fileproperties::StorageItemThumbnail>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetScaledImageAsThumbnailAsyncOverloadDefaultSizeDefaultOptions)(self as *const _ as *mut _, mode, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_scaled_image_as_thumbnail_async_overload_default_options(&self, mode: fileproperties::ThumbnailMode, requestedSize: u32) -> Result<ComPtr<foundation::IAsyncOperation<fileproperties::StorageItemThumbnail>>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn get_scaled_image_as_thumbnail_async(&self, mode: fileproperties::ThumbnailMode, requestedSize: u32, options: fileproperties::ThumbnailOptions) -> Result<ComPtr<foundation::IAsyncOperation<fileproperties::StorageItemThumbnail>>> {
        let mut out = null_mut();
...
impl IStorageLibrary {
    #[inline] pub unsafe fn request_add_folder_async(&self) -> Result<ComPtr<foundation::IAsyncOperation<StorageFolder>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).RequestAddFolderAsync)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn request_remove_folder_async(&self, folder: &StorageFolder) -> Result<ComPtr<foundation::IAsyncOperation<bool>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).RequestRemoveFolderAsync)(self as *const _ as *mut _, folder as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_folders(&self) -> Result<Option<ComPtr<foundation::collections::IObservableVector<StorageFolder>>>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn add_definition_changed(&self, handler: &foundation::TypedEventHandler<StorageLibrary, IInspectable>) -> Result<foundation::EventRegistrationToken> {
        let mut out = zeroed();
        let hr = ((*self.lpVtbl).add_DefinitionChanged)(self as *const _ as *mut _, handler as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }
    #[inline] pub unsafe fn remove_definition_changed(&self, eventCookie: foundation::EventRegistrationToken) -> Result<()> {
...
impl StorageLibrary {
    #[inline] pub fn get_library_async(libraryId: KnownLibraryId) -> Result<ComPtr<foundation::IAsyncOperation<StorageLibrary>>> { unsafe {
        <Self as RtActivatable<IStorageLibraryStatics>>::get_activation_factory().get_library_async(libraryId)
    }}
    #[cfg(feature="windows-system")] #[inline] pub fn get_library_for_user_async(user: &super::system::User, libraryId: KnownLibraryId) -> Result<ComPtr<foundation::IAsyncOperation<StorageLibrary>>> { unsafe {
...
impl IStorageLibrary3 {
    #[inline] pub unsafe fn are_folder_suggestions_available_async(&self) -> Result<ComPtr<foundation::IAsyncOperation<bool>>> {
        let mut out = null_mut();
...
impl IStorageLibraryChange {
    ...
    #[inline] pub unsafe fn get_storage_item_async(&self) -> Result<ComPtr<foundation::IAsyncOperation<IStorageItem>>> {
        let mut out = null_mut();
...
impl IStorageLibraryChangeReader {
    #[inline] pub unsafe fn read_batch_async(&self) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVectorView<StorageLibraryChange>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).ReadBatchAsync)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn accept_changes_async(&self) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
...
impl IStorageLibraryStatics {
    #[inline] pub unsafe fn get_library_async(&self, libraryId: KnownLibraryId) -> Result<ComPtr<foundation::IAsyncOperation<StorageLibrary>>> {
        let mut out = null_mut();
...
impl IStorageLibraryStatics2 {
    #[cfg(feature="windows-system")] #[inline] pub unsafe fn get_library_for_user_async(&self, user: &super::system::User, libraryId: KnownLibraryId) -> Result<ComPtr<foundation::IAsyncOperation<StorageLibrary>>> {
        let mut out = null_mut();
...
impl IStorageProvider2 {
    #[inline] pub unsafe fn is_property_supported_for_partial_file_async(&self, propertyCanonicalName: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<bool>>> {
        let mut out = null_mut();
...
impl IStorageStreamTransaction {
    ...
    #[inline] pub unsafe fn commit_async(&self) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
...
impl Buffer {
    ...
    #[inline] pub fn create_copy_from_memory_buffer(input: &foundation::IMemoryBuffer) -> Result<Option<ComPtr<Buffer>>> { unsafe {
        <Self as RtActivatable<IBufferStatics>>::get_activation_factory().create_copy_from_memory_buffer(input)
    }}
    #[inline] pub fn create_memory_buffer_over_ibuffer(input: &IBuffer) -> Result<Option<ComPtr<foundation::MemoryBuffer>>> { unsafe {
...
impl IBufferStatics {
    #[inline] pub unsafe fn create_copy_from_memory_buffer(&self, input: &foundation::IMemoryBuffer) -> Result<Option<ComPtr<Buffer>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).CreateCopyFromMemoryBuffer)(self as *const _ as *mut _, input as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap_optional(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn create_memory_buffer_over_ibuffer(&self, input: &IBuffer) -> Result<Option<ComPtr<foundation::MemoryBuffer>>> {
        let mut out = null_mut();
...
impl IDataReader {
    ...
    #[inline] pub unsafe fn read_date_time(&self) -> Result<foundation::DateTime> {
        let mut out = zeroed();
        let hr = ((*self.lpVtbl).ReadDateTime)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }
    #[inline] pub unsafe fn read_time_span(&self) -> Result<foundation::TimeSpan> {
        let mut out = zeroed();
...
impl IDataWriter {
    ...
    #[inline] pub unsafe fn write_date_time(&self, value: foundation::DateTime) -> Result<()> {
        let hr = ((*self.lpVtbl).WriteDateTime)(self as *const _ as *mut _, value);
        if hr == S_OK { Ok(()) } else { err(hr) }
    }
    #[inline] pub unsafe fn write_time_span(&self, value: foundation::TimeSpan) -> Result<()> {
    ...
    #[inline] pub unsafe fn flush_async(&self) -> Result<ComPtr<foundation::IAsyncOperation<bool>>> {
        let mut out = null_mut();
...
impl FileRandomAccessStream {
    #[inline] pub fn open_async(filePath: &HStringArg, accessMode: super::FileAccessMode) -> Result<ComPtr<foundation::IAsyncOperation<IRandomAccessStream>>> { unsafe {
        <Self as RtActivatable<IFileRandomAccessStreamStatics>>::get_activation_factory().open_async(filePath, accessMode)
    }}
    #[inline] pub fn open_with_options_async(filePath: &HStringArg, accessMode: super::FileAccessMode, sharingOptions: super::StorageOpenOptions, openDisposition: FileOpenDisposition) -> Result<ComPtr<foundation::IAsyncOperation<IRandomAccessStream>>> { unsafe {
    ...
    #[inline] pub fn open_transacted_write_async(filePath: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<super::StorageStreamTransaction>>> { unsafe {
        <Self as RtActivatable<IFileRandomAccessStreamStatics>>::get_activation_factory().open_transacted_write_async(filePath)
    }}
    #[inline] pub fn open_transacted_write_with_options_async(filePath: &HStringArg, openOptions: super::StorageOpenOptions, openDisposition: FileOpenDisposition) -> Result<ComPtr<foundation::IAsyncOperation<super::StorageStreamTransaction>>> { unsafe {
    ...
    #[cfg(feature="windows-system")] #[inline] pub fn open_for_user_async(user: &super::super::system::User, filePath: &HStringArg, accessMode: super::FileAccessMode) -> Result<ComPtr<foundation::IAsyncOperation<IRandomAccessStream>>> { unsafe {
        <Self as RtActivatable<IFileRandomAccessStreamStatics>>::get_activation_factory().open_for_user_async(user, filePath, accessMode)
    }}
    #[cfg(feature="windows-system")] #[inline] pub fn open_for_user_with_options_async(user: &super::super::system::User, filePath: &HStringArg, accessMode: super::FileAccessMode, sharingOptions: super::StorageOpenOptions, openDisposition: FileOpenDisposition) -> Result<ComPtr<foundation::IAsyncOperation<IRandomAccessStream>>> { unsafe {
    ...
    #[cfg(feature="windows-system")] #[inline] pub fn open_transacted_write_for_user_async(user: &super::super::system::User, filePath: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<super::StorageStreamTransaction>>> { unsafe {
    ...
    #[cfg(feature="windows-system")] #[inline] pub fn open_transacted_write_for_user_with_options_async(user: &super::super::system::User, filePath: &HStringArg, openOptions: super::StorageOpenOptions, openDisposition: FileOpenDisposition) -> Result<ComPtr<foundation::IAsyncOperation<super::StorageStreamTransaction>>> { unsafe {
...
impl IFileRandomAccessStreamStatics {
    #[inline] pub unsafe fn open_async(&self, filePath: &HStringArg, accessMode: super::FileAccessMode) -> Result<ComPtr<foundation::IAsyncOperation<IRandomAccessStream>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).OpenAsync)(self as *const _ as *mut _, filePath.get(), accessMode, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn open_with_options_async(&self, filePath: &HStringArg, accessMode: super::FileAccessMode, sharingOptions: super::StorageOpenOptions, openDisposition: FileOpenDisposition) -> Result<ComPtr<foundation::IAsyncOperation<IRandomAccessStream>>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn open_transacted_write_async(&self, filePath: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<super::StorageStreamTransaction>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).OpenTransactedWriteAsync)(self as *const _ as *mut _, filePath.get(), &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn open_transacted_write_with_options_async(&self, filePath: &HStringArg, openOptions: super::StorageOpenOptions, openDisposition: FileOpenDisposition) -> Result<ComPtr<foundation::IAsyncOperation<super::StorageStreamTransaction>>> {
        let mut out = null_mut();
    ...
    #[cfg(feature="windows-system")] #[inline] pub unsafe fn open_for_user_async(&self, user: &super::super::system::User, filePath: &HStringArg, accessMode: super::FileAccessMode) -> Result<ComPtr<foundation::IAsyncOperation<IRandomAccessStream>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).OpenForUserAsync)(self as *const _ as *mut _, user as *const _ as *mut _, filePath.get(), accessMode, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[cfg(feature="windows-system")] #[inline] pub unsafe fn open_for_user_with_options_async(&self, user: &super::super::system::User, filePath: &HStringArg, accessMode: super::FileAccessMode, sharingOptions: super::StorageOpenOptions, openDisposition: FileOpenDisposition) -> Result<ComPtr<foundation::IAsyncOperation<IRandomAccessStream>>> {
        let mut out = null_mut();
    ...
    #[cfg(feature="windows-system")] #[inline] pub unsafe fn open_transacted_write_for_user_async(&self, user: &super::super::system::User, filePath: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<super::StorageStreamTransaction>>> {
        let mut out = null_mut();
    ...
    #[cfg(feature="windows-system")] #[inline] pub unsafe fn open_transacted_write_for_user_with_options_async(&self, user: &super::super::system::User, filePath: &HStringArg, openOptions: super::StorageOpenOptions, openDisposition: FileOpenDisposition) -> Result<ComPtr<foundation::IAsyncOperation<super::StorageStreamTransaction>>> {
        let mut out = null_mut();
...
impl IInputStream {
    #[inline] pub unsafe fn read_async(&self, buffer: &IBuffer, count: u32, options: InputStreamOptions) -> Result<ComPtr<foundation::IAsyncOperationWithProgress<IBuffer, u32>>> {
        let mut out = null_mut();
...
impl IInputStreamReference {
    #[inline] pub unsafe fn open_sequential_read_async(&self) -> Result<ComPtr<foundation::IAsyncOperation<IInputStream>>> {
        let mut out = null_mut();
...
impl IOutputStream {
    #[inline] pub unsafe fn write_async(&self, buffer: &IBuffer) -> Result<ComPtr<foundation::IAsyncOperationWithProgress<u32, u32>>> {
        let mut out = null_mut();
...
impl RandomAccessStream {
    #[inline] pub fn copy_async(source: &IInputStream, destination: &IOutputStream) -> Result<ComPtr<foundation::IAsyncOperationWithProgress<u64, u64>>> { unsafe {
        <Self as RtActivatable<IRandomAccessStreamStatics>>::get_activation_factory().copy_async(source, destination)
    }}
    #[inline] pub fn copy_size_async(source: &IInputStream, destination: &IOutputStream, bytesToCopy: u64) -> Result<ComPtr<foundation::IAsyncOperationWithProgress<u64, u64>>> { unsafe {
        <Self as RtActivatable<IRandomAccessStreamStatics>>::get_activation_factory().copy_size_async(source, destination, bytesToCopy)
    }}
    #[inline] pub fn copy_and_close_async(source: &IInputStream, destination: &IOutputStream) -> Result<ComPtr<foundation::IAsyncOperationWithProgress<u64, u64>>> { unsafe {
...
impl IRandomAccessStreamReference {
    #[inline] pub unsafe fn open_read_async(&self) -> Result<ComPtr<foundation::IAsyncOperation<IRandomAccessStreamWithContentType>>> {
        let mut out = null_mut();
...
impl RandomAccessStreamReference {
    ...
    #[inline] pub fn create_from_uri(uri: &foundation::Uri) -> Result<Option<ComPtr<RandomAccessStreamReference>>> { unsafe {
...
impl IRandomAccessStreamReferenceStatics {
    ...
    #[inline] pub unsafe fn create_from_uri(&self, uri: &foundation::Uri) -> Result<Option<ComPtr<RandomAccessStreamReference>>> {
        let mut out = null_mut();
...
impl IRandomAccessStreamStatics {
    #[inline] pub unsafe fn copy_async(&self, source: &IInputStream, destination: &IOutputStream) -> Result<ComPtr<foundation::IAsyncOperationWithProgress<u64, u64>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).CopyAsync)(self as *const _ as *mut _, source as *const _ as *mut _, destination as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn copy_size_async(&self, source: &IInputStream, destination: &IOutputStream, bytesToCopy: u64) -> Result<ComPtr<foundation::IAsyncOperationWithProgress<u64, u64>>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn copy_and_close_async(&self, source: &IInputStream, destination: &IOutputStream) -> Result<ComPtr<foundation::IAsyncOperationWithProgress<u64, u64>>> {
        let mut out = null_mut();
...
impl ICompressor {
    #[inline] pub unsafe fn finish_async(&self) -> Result<ComPtr<foundation::IAsyncOperation<bool>>> {
        let mut out = null_mut();
...
impl IContentIndexer {
    #[inline] pub unsafe fn add_async(&self, indexableContent: &IIndexableContent) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).AddAsync)(self as *const _ as *mut _, indexableContent as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn update_async(&self, indexableContent: &IIndexableContent) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).UpdateAsync)(self as *const _ as *mut _, indexableContent as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn delete_async(&self, contentId: &HStringArg) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).DeleteAsync)(self as *const _ as *mut _, contentId.get(), &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn delete_multiple_async(&self, contentIds: &foundation::collections::IIterable<HString>) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).DeleteMultipleAsync)(self as *const _ as *mut _, contentIds as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn delete_all_async(&self) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).DeleteAllAsync)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn retrieve_properties_async(&self, contentId: &HStringArg, propertiesToRetrieve: &foundation::collections::IIterable<HString>) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IMapView<HString, IInspectable>>>> {
        let mut out = null_mut();
...
impl IContentIndexerQuery {
    #[inline] pub unsafe fn get_count_async(&self) -> Result<ComPtr<foundation::IAsyncOperation<u32>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetCountAsync)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_properties_async(&self) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVectorView<foundation::collections::IMapView<HString, IInspectable>>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetPropertiesAsync)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_properties_range_async(&self, startIndex: u32, maxItems: u32) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVectorView<foundation::collections::IMapView<HString, IInspectable>>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetPropertiesRangeAsync)(self as *const _ as *mut _, startIndex, maxItems, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_async(&self) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVectorView<IIndexableContent>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetAsync)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_range_async(&self, startIndex: u32, maxItems: u32) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVectorView<IIndexableContent>>>> {
        let mut out = null_mut();
...
impl IContentIndexerQueryOperations {
    #[inline] pub unsafe fn create_query_with_sort_order_and_language(&self, searchFilter: &HStringArg, propertiesToRetrieve: &foundation::collections::IIterable<HString>, sortOrder: &foundation::collections::IIterable<SortEntry>, searchFilterLanguage: &HStringArg) -> Result<Option<ComPtr<ContentIndexerQuery>>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn create_query_with_sort_order(&self, searchFilter: &HStringArg, propertiesToRetrieve: &foundation::collections::IIterable<HString>, sortOrder: &foundation::collections::IIterable<SortEntry>) -> Result<Option<ComPtr<ContentIndexerQuery>>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn create_query(&self, searchFilter: &HStringArg, propertiesToRetrieve: &foundation::collections::IIterable<HString>) -> Result<Option<ComPtr<ContentIndexerQuery>>> {
        let mut out = null_mut();
...
impl IQueryOptions {
    #[inline] pub unsafe fn get_file_type_filter(&self) -> Result<Option<ComPtr<foundation::collections::IVector<HString>>>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn get_sort_order(&self) -> Result<Option<ComPtr<foundation::collections::IVector<SortEntry>>>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn set_property_prefetch(&self, options: super::fileproperties::PropertyPrefetchOptions, propertiesToRetrieve: &foundation::collections::IIterable<HString>) -> Result<()> {
...
impl QueryOptions {
    #[inline] pub fn create_common_file_query(query: CommonFileQuery, fileTypeFilter: &foundation::collections::IIterable<HString>) -> Result<ComPtr<QueryOptions>> { unsafe {
...
impl IQueryOptionsFactory {
    #[inline] pub unsafe fn create_common_file_query(&self, query: CommonFileQuery, fileTypeFilter: &foundation::collections::IIterable<HString>) -> Result<ComPtr<QueryOptions>> {
        let mut out = null_mut();
...
impl IQueryOptionsWithProviderFilter {
    #[inline] pub unsafe fn get_storage_provider_id_filter(&self) -> Result<Option<ComPtr<foundation::collections::IVector<HString>>>> {
        let mut out = null_mut();
...
impl IStorageFileQueryResult {
    #[inline] pub unsafe fn get_files_async(&self, startIndex: u32, maxNumberOfItems: u32) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVectorView<super::StorageFile>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetFilesAsync)(self as *const _ as *mut _, startIndex, maxNumberOfItems, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_files_async_default_start_and_count(&self) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVectorView<super::StorageFile>>>> {
        let mut out = null_mut();
...
impl IStorageFileQueryResult2 {
    #[cfg(feature="windows-data")] #[inline] pub unsafe fn get_matching_properties_with_ranges(&self, file: &super::StorageFile) -> Result<Option<ComPtr<foundation::collections::IMap<HString, foundation::collections::IVectorView<super::super::data::text::TextSegment>>>>> {
        let mut out = null_mut();
...
impl IStorageFolderQueryOperations {
    #[inline] pub unsafe fn get_indexed_state_async(&self) -> Result<ComPtr<foundation::IAsyncOperation<IndexedState>>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn get_files_async(&self, query: CommonFileQuery, startIndex: u32, maxItemsToRetrieve: u32) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVectorView<super::StorageFile>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetFilesAsync)(self as *const _ as *mut _, query, startIndex, maxItemsToRetrieve, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_files_async_overload_default_start_and_count(&self, query: CommonFileQuery) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVectorView<super::StorageFile>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetFilesAsyncOverloadDefaultStartAndCount)(self as *const _ as *mut _, query, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_folders_async(&self, query: CommonFolderQuery, startIndex: u32, maxItemsToRetrieve: u32) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVectorView<super::StorageFolder>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetFoldersAsync)(self as *const _ as *mut _, query, startIndex, maxItemsToRetrieve, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_folders_async_overload_default_start_and_count(&self, query: CommonFolderQuery) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVectorView<super::StorageFolder>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetFoldersAsyncOverloadDefaultStartAndCount)(self as *const _ as *mut _, query, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_items_async(&self, startIndex: u32, maxItemsToRetrieve: u32) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVectorView<super::IStorageItem>>>> {
        let mut out = null_mut();
...
impl IStorageFolderQueryResult {
    #[inline] pub unsafe fn get_folders_async(&self, startIndex: u32, maxNumberOfItems: u32) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVectorView<super::StorageFolder>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetFoldersAsync)(self as *const _ as *mut _, startIndex, maxNumberOfItems, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_folders_async_default_start_and_count(&self) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVectorView<super::StorageFolder>>>> {
        let mut out = null_mut();
...
impl IStorageItemQueryResult {
    #[inline] pub unsafe fn get_items_async(&self, startIndex: u32, maxNumberOfItems: u32) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVectorView<super::IStorageItem>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetItemsAsync)(self as *const _ as *mut _, startIndex, maxNumberOfItems, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_items_async_default_start_and_count(&self) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVectorView<super::IStorageItem>>>> {
        let mut out = null_mut();
...
impl IStorageLibraryContentChangedTriggerDetails {
    ...
    #[inline] pub unsafe fn create_modified_since_query(&self, lastQueryTime: foundation::DateTime) -> Result<Option<ComPtr<StorageItemQueryResult>>> {
        let mut out = null_mut();
...
impl IStorageQueryResultBase {
    #[inline] pub unsafe fn get_item_count_async(&self) -> Result<ComPtr<foundation::IAsyncOperation<u32>>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn add_contents_changed(&self, handler: &foundation::TypedEventHandler<IStorageQueryResultBase, IInspectable>) -> Result<foundation::EventRegistrationToken> {
        let mut out = zeroed();
        let hr = ((*self.lpVtbl).add_ContentsChanged)(self as *const _ as *mut _, handler as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }
    #[inline] pub unsafe fn remove_contents_changed(&self, eventCookie: foundation::EventRegistrationToken) -> Result<()> {
        let hr = ((*self.lpVtbl).remove_ContentsChanged)(self as *const _ as *mut _, eventCookie);
        if hr == S_OK { Ok(()) } else { err(hr) }
    }
    #[inline] pub unsafe fn add_options_changed(&self, changedHandler: &foundation::TypedEventHandler<IStorageQueryResultBase, IInspectable>) -> Result<foundation::EventRegistrationToken> {
        let mut out = zeroed();
        let hr = ((*self.lpVtbl).add_OptionsChanged)(self as *const _ as *mut _, changedHandler as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }
    #[inline] pub unsafe fn remove_options_changed(&self, eventCookie: foundation::EventRegistrationToken) -> Result<()> {
        let hr = ((*self.lpVtbl).remove_OptionsChanged)(self as *const _ as *mut _, eventCookie);
        if hr == S_OK { Ok(()) } else { err(hr) }
    }
    #[inline] pub unsafe fn find_start_index_async(&self, value: &IInspectable) -> Result<ComPtr<foundation::IAsyncOperation<u32>>> {
        let mut out = null_mut();
...
impl IFileOpenPicker {
    ...
    #[inline] pub unsafe fn pick_single_file_async(&self) -> Result<ComPtr<foundation::IAsyncOperation<super::StorageFile>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).PickSingleFileAsync)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn pick_multiple_files_async(&self) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVectorView<super::StorageFile>>>> {
        let mut out = null_mut();
...
impl FileOpenPicker {
    #[inline] pub fn resume_pick_single_file_async() -> Result<ComPtr<foundation::IAsyncOperation<super::StorageFile>>> { unsafe {
...
impl IFileOpenPicker2 {
    #[inline] pub unsafe fn get_continuation_data(&self) -> Result<Option<ComPtr<foundation::collections::ValueSet>>> {
        let mut out = null_mut();
...
impl IFileOpenPickerStatics {
    #[inline] pub unsafe fn resume_pick_single_file_async(&self) -> Result<ComPtr<foundation::IAsyncOperation<super::StorageFile>>> {
        let mut out = null_mut();
...
impl IFileOpenPickerWithOperationId {
    #[inline] pub unsafe fn pick_single_file_async(&self, pickerOperationId: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<super::StorageFile>>> {
        let mut out = null_mut();
...
impl IFileSavePicker {
    ...
    #[inline] pub unsafe fn get_file_type_choices(&self) -> Result<Option<ComPtr<foundation::collections::IMap<HString, foundation::collections::IVector<HString>>>>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn pick_save_file_async(&self) -> Result<ComPtr<foundation::IAsyncOperation<super::StorageFile>>> {
        let mut out = null_mut();
...
impl IFolderPicker {
    ...
    #[inline] pub unsafe fn pick_single_folder_async(&self) -> Result<ComPtr<foundation::IAsyncOperation<super::StorageFolder>>> {
        let mut out = null_mut();
...
impl IFileOpenPickerUI {
    ...
    #[inline] pub unsafe fn get_allowed_file_types(&self) -> Result<Option<ComPtr<foundation::collections::IVectorView<HString>>>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn add_file_removed(&self, handler: &foundation::TypedEventHandler<FileOpenPickerUI, FileRemovedEventArgs>) -> Result<foundation::EventRegistrationToken> {
        let mut out = zeroed();
        let hr = ((*self.lpVtbl).add_FileRemoved)(self as *const _ as *mut _, handler as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }
    #[inline] pub unsafe fn remove_file_removed(&self, token: foundation::EventRegistrationToken) -> Result<()> {
        let hr = ((*self.lpVtbl).remove_FileRemoved)(self as *const _ as *mut _, token);
        if hr == S_OK { Ok(()) } else { err(hr) }
    }
    #[inline] pub unsafe fn add_closing(&self, handler: &foundation::TypedEventHandler<FileOpenPickerUI, PickerClosingEventArgs>) -> Result<foundation::EventRegistrationToken> {
        let mut out = zeroed();
        let hr = ((*self.lpVtbl).add_Closing)(self as *const _ as *mut _, handler as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }
    #[inline] pub unsafe fn remove_closing(&self, token: foundation::EventRegistrationToken) -> Result<()> {
...
impl IFileSavePickerUI {
    ...
    #[inline] pub unsafe fn add_file_name_changed(&self, handler: &foundation::TypedEventHandler<FileSavePickerUI, IInspectable>) -> Result<foundation::EventRegistrationToken> {
        let mut out = zeroed();
        let hr = ((*self.lpVtbl).add_FileNameChanged)(self as *const _ as *mut _, handler as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }
    #[inline] pub unsafe fn remove_file_name_changed(&self, token: foundation::EventRegistrationToken) -> Result<()> {
        let hr = ((*self.lpVtbl).remove_FileNameChanged)(self as *const _ as *mut _, token);
        if hr == S_OK { Ok(()) } else { err(hr) }
    }
    #[inline] pub unsafe fn add_target_file_requested(&self, handler: &foundation::TypedEventHandler<FileSavePickerUI, TargetFileRequestedEventArgs>) -> Result<foundation::EventRegistrationToken> {
        let mut out = zeroed();
        let hr = ((*self.lpVtbl).add_TargetFileRequested)(self as *const _ as *mut _, handler as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }
    #[inline] pub unsafe fn remove_target_file_requested(&self, token: foundation::EventRegistrationToken) -> Result<()> {
...
impl ICachedFileUpdaterUI {
    ...
    #[inline] pub unsafe fn add_file_update_requested(&self, handler: &foundation::TypedEventHandler<CachedFileUpdaterUI, FileUpdateRequestedEventArgs>) -> Result<foundation::EventRegistrationToken> {
        let mut out = zeroed();
        let hr = ((*self.lpVtbl).add_FileUpdateRequested)(self as *const _ as *mut _, handler as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }
    #[inline] pub unsafe fn remove_file_update_requested(&self, token: foundation::EventRegistrationToken) -> Result<()> {
        let hr = ((*self.lpVtbl).remove_FileUpdateRequested)(self as *const _ as *mut _, token);
        if hr == S_OK { Ok(()) } else { err(hr) }
    }
    #[inline] pub unsafe fn add_uirequested(&self, handler: &foundation::TypedEventHandler<CachedFileUpdaterUI, IInspectable>) -> Result<foundation::EventRegistrationToken> {
        let mut out = zeroed();
        let hr = ((*self.lpVtbl).add_UIRequested)(self as *const _ as *mut _, handler as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }
    #[inline] pub unsafe fn remove_uirequested(&self, token: foundation::EventRegistrationToken) -> Result<()> {
...
impl StorageProviderItemProperties {
    #[inline] pub fn set_async(item: &super::IStorageItem, itemProperties: &foundation::collections::IIterable<StorageProviderItemProperty>) -> Result<ComPtr<foundation::IAsyncAction>> { unsafe {
...
impl IStorageProviderItemPropertiesStatics {
    #[inline] pub unsafe fn set_async(&self, item: &super::IStorageItem, itemProperties: &foundation::collections::IIterable<StorageProviderItemProperty>) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
...
impl IStorageProviderItemPropertySource {
    #[inline] pub unsafe fn get_item_properties(&self, itemPath: &HStringArg) -> Result<Option<ComPtr<foundation::collections::IIterable<StorageProviderItemProperty>>>> {
        let mut out = null_mut();
...
impl IStorageProviderSyncRootInfo {
    ...
    #[inline] pub unsafe fn get_storage_provider_item_property_definitions(&self) -> Result<Option<ComPtr<foundation::collections::IVector<StorageProviderItemPropertyDefinition>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).get_StorageProviderItemPropertyDefinitions)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap_optional(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_recycle_bin_uri(&self) -> Result<Option<ComPtr<foundation::Uri>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).get_RecycleBinUri)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap_optional(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn set_recycle_bin_uri(&self, value: &foundation::Uri) -> Result<()> {
...
impl StorageProviderSyncRootManager {
    ...
    #[inline] pub fn get_current_sync_roots() -> Result<Option<ComPtr<foundation::collections::IVectorView<StorageProviderSyncRootInfo>>>> { unsafe {
...
impl IStorageProviderSyncRootManagerStatics {
    ...
    #[inline] pub unsafe fn get_current_sync_roots(&self) -> Result<Option<ComPtr<foundation::collections::IVectorView<StorageProviderSyncRootInfo>>>> {
        let mut out = null_mut();
...
impl IBasicProperties {
    ...
    #[inline] pub unsafe fn get_date_modified(&self) -> Result<foundation::DateTime> {
        let mut out = zeroed();
        let hr = ((*self.lpVtbl).get_DateModified)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_item_date(&self) -> Result<foundation::DateTime> {
        let mut out = zeroed();
...
impl IDocumentProperties {
    #[inline] pub unsafe fn get_author(&self) -> Result<Option<ComPtr<foundation::collections::IVector<HString>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).get_Author)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap_optional(out)) } else { err(hr) }
    }
    ...
    #[inline] pub unsafe fn get_keywords(&self) -> Result<Option<ComPtr<foundation::collections::IVector<HString>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).get_Keywords)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap_optional(out)) } else { err(hr) }
    }
...
impl GeotagHelper {
    #[cfg(feature="windows-devices")] #[inline] pub fn get_geotag_async(file: &super::IStorageFile) -> Result<ComPtr<foundation::IAsyncOperation<super::super::devices::geolocation::Geopoint>>> { unsafe {
        <Self as RtActivatable<IGeotagHelperStatics>>::get_activation_factory().get_geotag_async(file)
    }}
    #[cfg(feature="windows-devices")] #[inline] pub fn set_geotag_from_geolocator_async(file: &super::IStorageFile, geolocator: &super::super::devices::geolocation::Geolocator) -> Result<ComPtr<foundation::IAsyncAction>> { unsafe {
        <Self as RtActivatable<IGeotagHelperStatics>>::get_activation_factory().set_geotag_from_geolocator_async(file, geolocator)
    }}
    #[cfg(feature="windows-devices")] #[inline] pub fn set_geotag_async(file: &super::IStorageFile, geopoint: &super::super::devices::geolocation::Geopoint) -> Result<ComPtr<foundation::IAsyncAction>> { unsafe {
...
impl IGeotagHelperStatics {
    #[cfg(feature="windows-devices")] #[inline] pub unsafe fn get_geotag_async(&self, file: &super::IStorageFile) -> Result<ComPtr<foundation::IAsyncOperation<super::super::devices::geolocation::Geopoint>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetGeotagAsync)(self as *const _ as *mut _, file as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[cfg(feature="windows-devices")] #[inline] pub unsafe fn set_geotag_from_geolocator_async(&self, file: &super::IStorageFile, geolocator: &super::super::devices::geolocation::Geolocator) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
    ...
    #[cfg(feature="windows-devices")] #[inline] pub unsafe fn set_geotag_async(&self, file: &super::IStorageFile, geopoint: &super::super::devices::geolocation::Geopoint) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
...
impl IImageProperties {
    ...
    #[inline] pub unsafe fn get_date_taken(&self) -> Result<foundation::DateTime> {
        let mut out = zeroed();
        let hr = ((*self.lpVtbl).get_DateTaken)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }
    #[inline] pub unsafe fn set_date_taken(&self, value: foundation::DateTime) -> Result<()> {
    ...
    #[inline] pub unsafe fn get_latitude(&self) -> Result<Option<ComPtr<foundation::IReference<f64>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).get_Latitude)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap_optional(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_longitude(&self) -> Result<Option<ComPtr<foundation::IReference<f64>>>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn get_people_names(&self) -> Result<Option<ComPtr<foundation::collections::IVectorView<HString>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).get_PeopleNames)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap_optional(out)) } else { err(hr) }
    }
...
impl IMusicProperties {
    ...
    #[inline] pub unsafe fn get_genre(&self) -> Result<Option<ComPtr<foundation::collections::IVector<HString>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).get_Genre)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap_optional(out)) } else { err(hr) }
    }
    ...
    #[inline] pub unsafe fn get_duration(&self) -> Result<foundation::TimeSpan> {
        let mut out = zeroed();
        let hr = ((*self.lpVtbl).get_Duration)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }
    ...
    #[inline] pub unsafe fn get_composers(&self) -> Result<Option<ComPtr<foundation::collections::IVector<HString>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).get_Composers)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap_optional(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_conductors(&self) -> Result<Option<ComPtr<foundation::collections::IVector<HString>>>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn get_producers(&self) -> Result<Option<ComPtr<foundation::collections::IVector<HString>>>> {
        let mut out = null_mut();
    ...
    #[inline] pub unsafe fn get_writers(&self) -> Result<Option<ComPtr<foundation::collections::IVector<HString>>>> {
        let mut out = null_mut();
...
impl IStorageItemContentProperties {
    #[inline] pub unsafe fn get_music_properties_async(&self) -> Result<ComPtr<foundation::IAsyncOperation<MusicProperties>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetMusicPropertiesAsync)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_video_properties_async(&self) -> Result<ComPtr<foundation::IAsyncOperation<VideoProperties>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetVideoPropertiesAsync)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_image_properties_async(&self) -> Result<ComPtr<foundation::IAsyncOperation<ImageProperties>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetImagePropertiesAsync)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_document_properties_async(&self) -> Result<ComPtr<foundation::IAsyncOperation<DocumentProperties>>> {
        let mut out = null_mut();
...
impl IStorageItemExtraProperties {
    #[inline] pub unsafe fn retrieve_properties_async(&self, propertiesToRetrieve: &foundation::collections::IIterable<HString>) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IMap<HString, IInspectable>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).RetrievePropertiesAsync)(self as *const _ as *mut _, propertiesToRetrieve as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn save_properties_async(&self, propertiesToSave: &foundation::collections::IIterable<foundation::collections::IKeyValuePair<HString, IInspectable>>) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).SavePropertiesAsync)(self as *const _ as *mut _, propertiesToSave as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn save_properties_async_overload_default(&self) -> Result<ComPtr<foundation::IAsyncAction>> {
        let mut out = null_mut();
...
impl IVideoProperties {
    ...
    #[inline] pub unsafe fn get_directors(&self) -> Result<Option<ComPtr<foundation::collections::IVector<HString>>>> {
        let mut out = null_mut();
...
impl IStorageItemAccessList {
    ...
    #[inline] pub unsafe fn get_item_async(&self, token: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<super::IStorageItem>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetItemAsync)(self as *const _ as *mut _, token.get(), &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_file_async(&self, token: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<super::StorageFile>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetFileAsync)(self as *const _ as *mut _, token.get(), &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_folder_async(&self, token: &HStringArg) -> Result<ComPtr<foundation::IAsyncOperation<super::StorageFolder>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetFolderAsync)(self as *const _ as *mut _, token.get(), &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_item_with_options_async(&self, token: &HStringArg, options: AccessCacheOptions) -> Result<ComPtr<foundation::IAsyncOperation<super::IStorageItem>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetItemWithOptionsAsync)(self as *const _ as *mut _, token.get(), options, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_file_with_options_async(&self, token: &HStringArg, options: AccessCacheOptions) -> Result<ComPtr<foundation::IAsyncOperation<super::StorageFile>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetFileWithOptionsAsync)(self as *const _ as *mut _, token.get(), options, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_folder_with_options_async(&self, token: &HStringArg, options: AccessCacheOptions) -> Result<ComPtr<foundation::IAsyncOperation<super::StorageFolder>>> {
        let mut out = null_mut();
...
impl IStorageItemMostRecentlyUsedList {
    #[inline] pub unsafe fn add_item_removed(&self, handler: &foundation::TypedEventHandler<StorageItemMostRecentlyUsedList, ItemRemovedEventArgs>) -> Result<foundation::EventRegistrationToken> {
        let mut out = zeroed();
        let hr = ((*self.lpVtbl).add_ItemRemoved)(self as *const _ as *mut _, handler as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }
    #[inline] pub unsafe fn remove_item_removed(&self, eventCookie: foundation::EventRegistrationToken) -> Result<()> {
...
impl IFileInformationFactory {
    #[inline] pub unsafe fn get_items_async(&self, startIndex: u32, maxItemsToRetrieve: u32) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVectorView<IStorageItemInformation>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetItemsAsync)(self as *const _ as *mut _, startIndex, maxItemsToRetrieve, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_items_async_default_start_and_count(&self) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVectorView<IStorageItemInformation>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetItemsAsyncDefaultStartAndCount)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_files_async(&self, startIndex: u32, maxItemsToRetrieve: u32) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVectorView<FileInformation>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetFilesAsync)(self as *const _ as *mut _, startIndex, maxItemsToRetrieve, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_files_async_default_start_and_count(&self) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVectorView<FileInformation>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetFilesAsyncDefaultStartAndCount)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_folders_async(&self, startIndex: u32, maxItemsToRetrieve: u32) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVectorView<FolderInformation>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetFoldersAsync)(self as *const _ as *mut _, startIndex, maxItemsToRetrieve, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
    #[inline] pub unsafe fn get_folders_async_default_start_and_count(&self) -> Result<ComPtr<foundation::IAsyncOperation<foundation::collections::IVectorView<FolderInformation>>>> {
        let mut out = null_mut();
        let hr = ((*self.lpVtbl).GetFoldersAsyncDefaultStartAndCount)(self as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(ComPtr::wrap(out)) } else { err(hr) }
    }
...
impl IStorageItemInformation {
    ...
    #[inline] pub unsafe fn add_thumbnail_updated(&self, changedHandler: &foundation::TypedEventHandler<IStorageItemInformation, IInspectable>) -> Result<foundation::EventRegistrationToken> {
        let mut out = zeroed();
        let hr = ((*self.lpVtbl).add_ThumbnailUpdated)(self as *const _ as *mut _, changedHandler as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }
    #[inline] pub unsafe fn remove_thumbnail_updated(&self, eventCookie: foundation::EventRegistrationToken) -> Result<()> {
        let hr = ((*self.lpVtbl).remove_ThumbnailUpdated)(self as *const _ as *mut _, eventCookie);
        if hr == S_OK { Ok(()) } else { err(hr) }
    }
    #[inline] pub unsafe fn add_properties_updated(&self, changedHandler: &foundation::TypedEventHandler<IStorageItemInformation, IInspectable>) -> Result<foundation::EventRegistrationToken> {
        let mut out = zeroed();
        let hr = ((*self.lpVtbl).add_PropertiesUpdated)(self as *const _ as *mut _, changedHandler as *const _ as *mut _, &mut out);
        if hr == S_OK { Ok(out) } else { err(hr) }
    }
    #[inline] pub unsafe fn remove_properties_updated(&self, eventCookie: foundation::EventRegistrationToken) -> Result<()> {
